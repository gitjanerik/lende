...
Runde-budsjettet er hevet fra 4 til 12. Å skille navnebrødre koster runder: «Vardåsen» finnes flere steder i Asker, så modellen brukte opp budsjettet på `sok_i_kartet` før den rakk `foreslaa_tur`. Neurons koster lite (10 000 per døgn gratis, deretter $0,011 per 1000), så taket koster ventetid framfor penger — derfor ikke høyere enn 12. Viktigere er at taket ikke lenger kan svelge en handling: har modellen ett kall på bordet når taket nås, blir det utført og samtalen avsluttet, i stedet for at kallet forsvinner stille. Taket verner mot at modellen går i løkke, og et allerede formulert kall er ingen ny runde.
