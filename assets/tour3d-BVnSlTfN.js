...
const vec3 doneColor = vec3(${js.r.toFixed(4)}, ${js.g.toFixed(4)}, ${js.b.toFixed(4)});
const vec3 remainColor = vec3(${Ms.r.toFixed(4)}, ${Ms.g.toFixed(4)}, ${Ms.b.toFixed(4)});`).replace(`#include <color_fragment>`,`#include <color_fragment>
...
diffuseColor.rgb = mix(diffuseColor.rgb, vec3(1.0, 1.0, 1.0), glow * 0.55);`)};let u=new G(a,l);return u.frustumCulled=!1,{mesh:u,geometry:a,material:l,setProgress(e){c.uProgressM.value=e}}}function Ps({radiusM:e=9}={}){let t=new J(e,16,12),n=new ie({color:14427686}),r=new G(t,n),i=new Ae(e*1.6,e*2.2,32),a=new ie({color:14427686,transparent:!0,opacity:.5,side:2}),o=new G(i,a);return o.rotation.x=-Math.PI/2,{sphere:r,ring:o,geometries:[t,i],materials:[n,a],setPosition(e,t,n){r.position.set(e,t,n),o.position.set(e,t-6,n)},pulse(e){let t=1+.15*Math.sin(e*3);o.scale.setScalar(t),a.opacity=.35+.2*Math.sin(e*3)}}}function Fs(e){return Number.isFinite(e)?e<3e3?64:e<=12e3?128:256:128}function Is({totalM:e,estWalkMinutes:t=null,cumAscent:n=null,speedKmh:r=4.5,timeScale:i=128}={}){let a=0,o=!1,s=1,c=0,l=!1,u=e=>{if(!n||!n.dM.length)return 0;let{dM:t,aM:r}=n,i=0,a=t.length-1;if(e<=t[0])return r[0];if(e>=t[a])return r[a];for(;i<a;){let n=i+a>>1;t[n]<e?i=n+1:a=n}let o=i-1,s=t[i]-t[o]||1,c=(e-t[o])/s;return r[o]+(r[i]-r[o])*c},d=n?.aM.length?n.aM[n.aM.length-1]:0;return{play(){l||(o=!0)},pause(){o=!1},restart(){a=0,c=0,l=!1,o=!0},seek(t){a=Math.max(0,Math.min(e,t)),l=a>=e,l&&(o=!1)},setSpeed(e){r=Math.max(.5,e)},setTimeScale(e){i=Math.max(.1,e)},setSpeedFactor(e){s=Math.max(0,Math.min(1,e))},tick(t){if(!o||l)return{alongM:a,finished:l};let n=Math.min(t,.1);return a+=r/3.6*i*n*s,c+=n*i*s,a>=e&&(a=e,l=!0,o=!1),{alongM:a,finished:l}},stats(){let n=Math.max(0,e-a),f=u(a),p=Math.max(0,d-f);return{alongM:a,totalM:e,remainingM:n,pctDone:e>0?a/e:0,ascentSoFarM:f,remainingClimbM:p,etaMin:t?t(n,p):null,virtualElapsedMin:c/60,playing:o,finished:l,speedKmh:r,timeScale:i,speedFactor:s}},get playing(){return o},get alongM(){return a},get finished(){return l}}}function Ls(e){let t=(e??[]).filter(e=>e.elev!=null&&Number.isFinite(e.elev));if(t.length<2)return null;let n=new Float32Array(t.length),r=new Float32Array(t.length),i=0;n[0]=t[0].distM;for(let e=1;e<t.length;e++){let a=t[e].elev-t[e-1].elev;a>0&&(i+=a),n[e]=t[e].distM,r[e]=i}return{dM:n,aM:r}}var Rs=.25,zs=2e3;function Bs(e=[],{onEnter:t=null,onExit:n=null}={}){let r=e.slice(),i=0,a=`CRUISE`,o=0,s=0,c=null,l=!0,u=e=>{i=r.findIndex(t=>t.alongM>e),i<0&&(i=r.length)},d=()=>{c&&n&&n(c),c=null,a=`RESUME`,s=zs,i++};return{tick(e,n){if(!l||!r.length)return{speedFactor:1,state:a,active:c};let u=r[i]??null;if(a===`CRUISE`&&u&&e>=u.alongM-u.approachM&&(a=`APPROACH`),a===`APPROACH`){if(!u)return a=`CRUISE`,{speedFactor:1,state:a,active:c};if(e>=u.alongM)a=`HOLD`,o=u.holdMs,c=u,t&&t(u);else{let t=Math.max(0,Math.min(1,(u.alongM-e)/u.approachM));return{speedFactor:Rs+.75*(t*t*(3-2*t)),state:a,active:c}}}if(a===`HOLD`){if(o-=n,o<=0)d();else return{speedFactor:0,state:a,active:c}}if(a===`RESUME`){if(s-=n,s<=0)a=`CRUISE`;else return{speedFactor:Rs+.75*(1-s/zs),state:a,active:c}}return{speedFactor:1,state:a,active:c}},skip(){a===`HOLD`&&d()},seek(e){a===`HOLD`&&c&&n&&n(c),c=null,a=`CRUISE`,u(e)},setEvents(e,t=0){r=(e??[]).slice(),u((a===`HOLD`||a===`APPROACH`)&&c?c.alongM:t)},setEnabled(e){l=!!e,!l&&a===`HOLD`&&d()},eventNear(e,t=150){let n=null,i=1/0;for(let a of r){let r=Math.abs(a.alongM-e);r<=t&&r<i&&(i=r,n=a)}return n},get state(){return a},get active(){return c},get pending(){return r.length-i}}}var Vs=1483594,Hs=14427686,Us=16096779;function Ws(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`);t.fillStyle=`#1d4ed8`,Gs(t,8,8,112,112,26),t.fill(),t.strokeStyle=`#fff`,t.lineWidth=6,Gs(t,8,8,112,112,26),t.stroke(),t.fillStyle=`#fff`,t.font=`bold 84px system-ui, sans-serif`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(`P`,64,70);let n=new ye(e);return n.colorSpace=Ie,n}function Gs(e,t,n,r,i,a){e.beginPath(),e.moveTo(t+a,n),e.arcTo(t+r,n,t+r,n+i,a),e.arcTo(t+r,n+i,t,n+i,a),e.arcTo(t,n+i,t,n,a),e.arcTo(t,n,t+r,n,a),e.closePath()}function Ks(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`);t.fillStyle=`#92400e`,Gs(t,8,8,112,112,26),t.fill(),t.strokeStyle=`#fff`,t.lineWidth=6,Gs(t,8,8,112,112,26),t.stroke(),t.strokeStyle=`#fff`,t.lineWidth=11,t.lineCap=`round`,t.beginPath(),t.moveTo(82,98),t.lineTo(82,58),t.arc(64,58,18,0,Math.PI,!0),t.lineTo(46,76),t.stroke(),t.fillStyle=`#fff`,t.beginPath(),t.moveTo(32,74),t.lineTo(60,74),t.lineTo(46,100),t.closePath(),t.fill();let n=new ye(e);return n.colorSpace=Ie,n}function qs({route:e,via:t=[],isLoop:n=!1,parkingSpots:r=[],pauseSpots:i=[]},a,o){let s=new Y,c=new Y;s.add(c);let l=[],u=[],d=[],f=[],p=new Map,m=(e,t,n,r)=>{let i=new Y,c=new me(Uo,Uo,55,8),m=new ie({color:16777215}),h=new G(c,m);h.position.y=55/2;let g=new J(9,16,12),_=new ie({color:n}),v=new G(g,_);v.position.y=60.4,i.add(h),i.add(v);let[y,b,x]=Jo(a,o,e,t);i.position.set(y,b,x),l.push(c,g),u.push(m,_),s.add(i),d.push(i);let S={...r,world:[y,b,x]};for(let e of[h,v])f.push(e),p.set(e,S)},h=e.coordinates,[g,_]=h[0];if(m(g,_,Vs,{kind:`start`,name:n?`Start og mål`:`Start`}),!n){let[e,t]=h[h.length-1];m(e,t,Hs,{kind:`mål`,name:`Mål`})}for(let e of t)m(e.svgX,e.svgY,Us,{kind:`via`,name:`Vendepunkt`});let v=(e,t,{sizeM:n,liftM:r,parent:i,kind:s,label:c})=>{if(!e.length)return;let l=t(),d=new nt({map:l,transparent:!0,depthWrite:!1});u.push(d),d.userData={tex:l};for(let t of e){let e=new he(d);e.scale.set(n,n,1);let[l,u,m]=Jo(a,o,t.x,t.y,r);e.position.set(l,u,m),i.add(e),f.push(e),p.set(e,{kind:s,name:t.name||c,world:Jo(a,o,t.x,t.y)})}};return v(r,Ws,{sizeM:46,liftM:40,parent:s,kind:`parkering`,label:`Parkering`}),v(i,Ks,{sizeM:42,liftM:95,parent:c,kind:`rast`,label:`Rasteplass`}),{group:s,geometries:l,materials:u,hitMeshes:f,pick(e){for(let t of e.intersectObjects(f,!1)){if(t.object.parent&&t.object.parent.visible===!1)continue;let e=p.get(t.object);if(e)return e}return null},setPinsVisible(e){c.visible=!!e},update(e){for(let t of d)t.scale.setScalar(Xo(e.position,t.position.x,t.position.y,t.position.z))},dispose(){for(let e of l)e.dispose();for(let e of u)e.userData?.tex?.dispose(),e.dispose()}}}function Js({color:e=16498468}={}){let t=new Y,n=new Ae(24,34,40),r=new ie({color:e,transparent:!0,opacity:.7,side:2,depthWrite:!1}),i=new G(n,r);i.rotation.x=-Math.PI/2,t.add(i);let a=new X(14,220),o=new ie({color:e,transparent:!0,opacity:.35,blending:2,depthWrite:!1,side:2}),s=new G(a,o);return s.position.y=110,t.add(s),t.visible=!1,{group:t,geometries:[n,a],materials:[r,o],showAt(e,n,r){t.position.set(e,n+2,r),t.visible=!0},hide(){t.visible=!1},update(e,n){if(!t.visible)return;let a=1+.2*Math.sin(e*2.5);i.scale.setScalar(a),r.opacity=.5+.25*Math.sin(e*2.5);let o=n.position.x-t.position.x,c=n.position.z-t.position.z;s.rotation.y=Math.atan2(o,c)}}}var Ys=959977,Xs=3718648,Zs=1.5,Qs=15,$s=120,ec=3,tc=2.6;function nc(e,t){let n=new Y;n.visible=!1;let i=new Y,a=new me(Uo,Uo,55,8),o=new ie({color:16777215}),s=new G(a,o);s.position.y=55/2;let c=new J(9,16,12),l=new ie({color:Ys}),u=new G(c,l);u.position.y=60.4,i.add(s),i.add(u),n.add(i);let d=new Ae(.9,1,48),f=[];for(let e=0;e<ec;e++){let t=new ie({color:Xs,transparent:!0,opacity:0,side:2,depthWrite:!1}),r=new G(d,t);r.rotation.x=-Math.PI/2,r.position.y=Zs,n.add(r),f.push({mesh:r,mat:t,phase:e/ec})}for(let e of[n,i,s,u,...f.map(e=>e.mesh)])e.frustumCulled=!1;let p=30;return{group:n,hitMeshes:[u,s],get visible(){return n.visible},get position(){return n.position},setPosition(i){let a=i&&Number.isFinite(i.x)&&Number.isFinite(i.y)&&i.x>=0&&i.x<=t.widthM&&i.y>=0&&i.y<=t.heightM;if(n.visible=!!a,!a)return;let o=r(e,i.x,i.y),[s,c,l]=t.toWorld(i.x,i.y,Number.isFinite(o)?o:0);n.position.set(s,c,l),p=Math.min($s,Math.max(Qs,i.accuracyM??30))},update(e,t){if(n.visible){for(let t of f){let n=(e/tc+t.phase)%1,r=Math.max(.001,p*n);t.mesh.scale.set(r,r,1),t.mat.opacity=.5*(1-n)}i.scale.setScalar(Xo(t.position,n.position.x,n.position.y,n.position.z))}},dispose(){a.dispose(),c.dispose(),d.dispose(),o.dispose(),l.dispose();for(let e of f)e.mat.dispose()}}}var rc=3e5,ic=30;function ac({windowMs:e=rc,minMoveM:t=ic}={}){let n=[],r=t=>{for(;n.length&&n[0].t<t-e;)n.shift()};return{push(e,t,i){!Number.isFinite(e)||!Number.isFinite(t)||!Number.isFinite(i)||n.length&&i<=n[n.length-1].t||(n.push({x:e,y:t,t:i}),r(i))},heading(e){if(r(e),n.length<2)return null;let i=n[0],a=n[n.length-1],o=a.x-i.x,s=a.y-i.y,c=Math.hypot(o,s);return c<t?null:[o/c,s/c]},reset(){n.length=0}}}var oc=250,sc=90,cc=25,lc=120,uc=30;async function dc(e,{dem:n,meta:a,getTextureSpec:s,onProgress:c=null,onTextureNote:l=null,pathFeatures:d=[],barrierFeatures:f=[],features:p=[],tour:m=null,options:h={}}){if(!n)throw new lo(`no-dem`,`Kartet mangler høydedata`);if(m&&(!m.route?.coordinates||m.route.coordinates.length<2))throw new lo(`no-route`,`Ingen rute å vise`);let{exaggeration:g=1.15,speedKmh:_=4.5,timeScale:v=null}=h,y={},b=await uo(e,{dem:n,meta:a,getTextureSpec:s,onProgress:c,onTextureNote:l,options:{exaggeration:g}},y),{scene:x,camera:S,coords:C,terrain:w,loop:T}=b,E=new Map,D=(e,t)=>{for(let n of E.get(e)??[])try{n(t)}catch{}},O=m?.estWalkMinutes??h.estWalkMinutes??null,ee=v??(m?Fs(m.route.lengthM):128),k=Ho(d,n,C),A=!0;x.add(k.group),T.track(k),k.setResolution(e.clientWidth,e.clientHeight);let te=null,ne=()=>(te===null&&(te=d?.length?o(d,{...i,elevationAt:t(n),barriers:f}):!1),te||null),j=is({scene:x,dem:n,coords:C,project:b.project});p?.length&&j.setFeatures(p);let N=Js();x.add(N.group),T.track({dispose:()=>{for(let e of N.geometries)e.dispose();for(let e of N.materials)e.dispose()}});let re=null,P=ac(),ie=e=>{e&&!re&&(re=nc(n,C),x.add(re.group),T.track(re)),re?.setPosition(e),e?P.push(e.x,e.y,Date.now()):P.reset()},ae=null;m&&(ae=qs({route:m.route,via:m.via??[],isLoop:!!m.isLoop,parkingSpots:m.parkingSpots??[],pauseSpots:m.pauseSpots??[]},n,C),x.add(ae.group),T.track(ae));let F=null,oe=null,I=null,L=null,R=null,z=null,B=0,V=null,se=!1,H=null,ce=`free`,le=!1,ue=e=>{let t=r(n,e.x,e.y);return C.toWorld(e.x,e.y,Number.isFinite(t)?t:0)},de=Bs([],{onEnter:e=>{let[t,n,r]=ue(e);N.showAt(t,n,r),ce===`follow`&&z?.setFrameTarget({x:t,y:n,z:r,radius:e.areaM2?Math.sqrt(e.areaM2/Math.PI):60}),D(`feature-enter`,{feature:e})},onExit:e=>{N.hide(),z?.clearFrameTarget(),D(`feature-exit`,{feature:e})}}),U=!1;de.setEnabled(!1);let W=()=>{if(I&&=(x.remove(I.mesh),I.geometry.dispose(),I.material.dispose(),null),L){x.remove(L.sphere),x.remove(L.ring);for(let e of L.geometries)e.dispose();for(let e of L.materials)e.dispose();L=null}},fe=()=>{W(),z?.dispose(),z=null,R=null,oe=null,F=null,V=null,H=null,B=0,de.setEvents([],0)};function G(e,{alongM:t=0,autoplay:r=!1,animateCamera:i=!0}={}){W(),F=e;let a=Es(e.coordinates,n,C);oe=As(a),I=Ns(a),x.add(I.mesh),L=Ps(),x.add(L.sphere),x.add(L.ring);let o=e.fixed&&m?.profileSamples?.length?m.profileSamples:Ds(a,C);for(R=Is({totalM:a.totalM,estWalkMinutes:O,cumAscent:Ls(o),speedKmh:_,timeScale:ee}),t>0&&R.seek(Math.min(t,a.totalM)),z?z.setRouteLookup(oe):(z=Eo({camera:S,dem:n,coords:C,routeLookup:oe,domElement:b.renderer.domElement}),z.onHold(e=>D(`camera-hold`,{holding:e}))),de.setEvents(m?.routeFeatures?.length?yt(m.routeFeatures,e.coordinates):[],R.alongM),de.setEnabled(U),B=0,V=null,H=null;B<(F.junctions?.length??0)&&F.junctions[B].alongM<=R.alongM;)B++;pe({inherit:!1,animate:i}),r?R.play():he()}function pe({inherit:e=!0,animate:t=!0}={}){!F||!z||(ce=`follow`,le=!1,N.hide(),K.setEnabled(!1),z.enter(R.alongM,{inherit:e,animate:t}),z.setInputEnabled(R.playing),D(`camera`,{detached:!1}))}function me(){if(!F||ce===`free`)return;ce=`free`,le=!1,z?.setInputEnabled(!1),z?.clearFrameTarget();let e=oe.at(R.alongM),t=Math.hypot(S.position.x-e[0],S.position.y-e[1],S.position.z-e[2]);K.armFromCamera(t),D(`camera`,{detached:!0})}function he(){if(!F||ce!==`follow`)return;let e=R.playing;K.setEnabled(!e),z?.setInputEnabled(e)}let K=await Lo({camera:S,dem:n,coords:C,domElement:b.renderer.domElement,autoRotate:!m,enabled:!m});K.onTakeOver(()=>{!F||R?.playing||me()}),K.onTakeOverCancelled(()=>{F&&ce===`free`&&(le=!0)});function ge(e,t){let n=ne();if(!n)return!1;let r=K.cameraSvgXY(),i=ws(n,[e,t],r,{tolM:sc});if(!i)return!1;let a=Cs(n,i.nodeId,{headingXY:i.headingXY});return a.coordinates.length<2?!1:(G({...a,fixed:!1},{autoplay:!1}),D(`trip-start`,{lengthM:a.lengthM,junctions:a.junctions.length,fixed:!1}),!0)}function _e(){if(!F||F.fixed)return;let e=oe?.at(R?.alongM??0),t=e?Math.hypot(S.position.x-e[0],S.position.y-e[1],S.position.z-e[2]):400;fe(),N.hide(),ce=`free`,K.armFromCamera(t),D(`trip-end`,{})}let ve=new u,ye=new M;function be(e,{radiusM:t=60,headingXY:n=null}={}){F&&(R.pause(),me(),le=!1),K.flyTo(e[0],e[1],e[2],{radiusM:t,headingXY:n})}function q(e){if(ce===`follow`&&z?.holdConsumed)return;let t=b.renderer.domElement.getBoundingClientRect();if(ye.x=(e.clientX-t.left)/t.width*2-1,ye.y=-((e.clientY-t.top)/t.height)*2+1,ve.setFromCamera(ye,S),re?.visible&&ve.intersectObjects(re.hitMeshes,!1)[0]){let e=re.position;N.hide(),be([e.x,e.y,e.z],{radiusM:90,headingXY:P.heading(Date.now())}),D(`fly-to-gps`,{});return}let n=j.raycast(ve);if(n){N.showAt(...n.world),be(n.world,{radiusM:n.radiusM}),D(`feature`,{feature:{...n.feature,type:Ct(n.feature)}});return}let r=ae?.pick(ve);if(r){N.showAt(...r.world),be(r.world,{radiusM:70}),D(`feature`,{feature:{name:r.name,type:r.kind===`parkering`||r.kind===`rast`?r.kind:`veipunkt`,waypoint:r.kind}});return}let i=ve.intersectObject(w.mesh,!1)[0];if(!i)return;let{x:a,y:o}=C.toSvg(i.point.x,i.point.z),s=()=>{let e=ne();return!!e&&!!ws(e,[a,o],K.cameraSvgXY(),{tolM:sc})};if(F){F.fixed&&A&&s()&&D(`tour-locked`,{});return}if(!A){s()&&D(`paths-hidden`,{x:a,y:o});return}ge(a,o)||D(`no-path`,{x:a,y:o})}let xe=as(b.renderer.domElement,q),Se=0,Ce=!1;Object.assign(y,{onResize(e,t){k.setResolution(e,t)},onFrame(e,t){if(le&&pe({inherit:!0,animate:!1}),F&&R){let n=e*1e3,r=R.finished;R.tick(e);let i=R.alongM;!r&&R.finished&&(de.seek(i),he());let a=R.playing?de.tick(i,n):{speedFactor:1,state:de.state,active:de.active};R.setSpeedFactor(a.speedFactor);let o=oe.at(i);L.setPosition(o[0],o[1],o[2]),L.pulse(t),I.setProgress(i),ce===`follow`?z.update(e,i):K.update(e),we(i)}else K.update(e);N.update(t,S),re?.update(t,S),ae?.update(S),b.updateAmbient(e),j.update(S),b.render();let n=t*1e3;if(j.maybeDeclutter(n),n-Se>oc){if(Se=n,F&&R){let e=R.stats(),t=oe.at(R.alongM);D(`progress`,{...e,walking:!0,fixed:!!F.fixed,detached:ce===`free`,elevM:C.worldYToElev(t[1])-3}),e.finished&&D(`finished`,e)}else D(`progress`,{walking:!1,autoRotating:K.autoRotating,elevM:C.worldYToElev(S.position.y)})}},onContextLost:()=>D(`context-lost`,{})});function we(e){if(!F.junctions?.length)return;let t=F.junctions[B];t&&e>=t.alongM-lc&&V!==t&&(V=t,D(`junction`,{junction:t})),se&&V&&H!==V&&R.playing&&e>=V.alongM-cc&&(H=V,R.pause(),he(),D(`junction-pause`,{junction:V})),t&&e>t.alongM+uc&&(B++,H===t&&(H=null),V===t&&(V=null,D(`junction`,{junction:null})))}return m&&G({...m.route,fixed:!0},{autoplay:!1,animateCamera:!1}),T.start(),D(`ready`,{pathCount:d?.length??0,fixed:!!m}),{setFeatures(e){j.setFeatures(e??[])},setPinsVisible(e){j.setVisible(e),ae?.setPinsVisible(e),e||N.hide()},setPinGroups(e){j.setGroups(e)},setPathsVisible(e){A=!!e,k.setVisible(A)},get hasPaths(){return!k.isEmpty},setUserPosition:ie,overview(){N.hide(),F&&(R.pause(),me(),le=!1),K.resetToOverview()},followRoute(){pe({inherit:!0})},get detached(){return ce===`free`},get autoRotating(){return K.autoRotating},get walking(){return!!F},get isFixedTour(){return!!F?.fixed},get tripLengthM(){return F?.lengthM??0},get totalM(){return oe?.totalM??0},play(){R&&(pe({inherit:!1,animate:!0}),R.play(),he())},pause(){R?.pause(),he()},restart(){R&&(R.restart(),de.seek(0),pe({inherit:!1,animate:!0}),he())},stopTrip(){_e()},scrubStart(){R?.pause(),ce===`free`&&pe({inherit:!0}),he()},scrub(e){if(!(!R||!F)){for(R.seek(e),de.seek(e),B=0;B<(F.junctions?.length??0)&&F.junctions[B].alongM<=R.alongM;)B++;V&&(V=null,H=null,D(`junction`,{junction:null}))}},scrubEnd(){he()},setTimeScale(e){ee=e,R?.setTimeScale(e)},setAutoPauseJunctions(e){se=!!e},chooseBranch(e){let t=ne();if(!t||!F||F.fixed||!V)return;let n=Ts(t,F,V,e);if(n===F)return;let r=R.alongM;V=null,D(`junction`,{junction:null}),G({...n,fixed:!1},{alongM:r,autoplay:!0})},setPoiStops(e){U=!!e,de.setEnabled(U),U&&R&&de.seek(R.alongM)},skipFeature(){de.skip()},setContoursVisible:e=>b.setContoursVisible(e),get contoursVisible(){return b.contoursVisible},setNightMode:e=>b.setNightMode(e),setVaer:e=>b.setVaer(e),on:(e,t)=>{E.has(e)||E.set(e,new Set),E.get(e).add(t)},off:(e,t)=>E.get(e)?.delete(t),resize:()=>b.resize(),get state(){return R?{...R.stats(),walking:!0,fixed:!!F?.fixed,detached:ce===`free`}:{walking:!1}},dispose(){Ce||(Ce=!0,xe.dispose(),fe(),K.dispose(),j.dispose(),E.clear(),b.dispose())}}}var fc=e({PIN_GROUPS:()=>wt,TourSceneError:()=>lo,buildFeatureTimeline:()=>yt,clusterFeaturesByMeters:()=>bt,collectAllFeatures:()=>St,collectBrukerminnePins:()=>_t,collectMapFeatures:()=>Tt,countByGroup:()=>ft,create3dScene:()=>dc,defaultTimeScale:()=>Fs,featureType:()=>Ct,findParkingSpots:()=>mt,findPauseSpots:()=>ht,fmtAscent:()=>Ot,fmtDurationMin:()=>kt,fmtKm:()=>Dt,fmtMoh:()=>Et,groupOfKind:()=>pt,loadHeritageForMap:()=>vt,loadNveFeatures:()=>xt,poiColor:()=>c});export{wt as PIN_GROUPS,lo as TourSceneError,yt as buildFeatureTimeline,bt as clusterFeaturesByMeters,St as collectAllFeatures,_t as collectBrukerminnePins,Tt as collectMapFeatures,ft as countByGroup,dc as create3dScene,Fs as defaultTimeScale,Ct as featureType,mt as findParkingSpots,ht as findPauseSpots,Ot as fmtAscent,kt as fmtDurationMin,Dt as fmtKm,Et as fmtMoh,pt as groupOfKind,$i as i,vt as loadHeritageForMap,xt as loadNveFeatures,ya as n,c as poiColor,ea as r,fc as t};