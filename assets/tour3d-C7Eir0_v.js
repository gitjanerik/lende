...
void main() {
	...
	`}var jn=class extends O{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ye(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var ni={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ri(e,t){let n=ni[t];return n===void 0?(W(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ii=new Z;function ai(){return Ge.getLuminanceCoefficients(ii),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ii.x.toFixed(4)}, ${ii.y.toFixed(4)}, ${ii.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
    ...
    `}),r=new G(t,n);return r.frustumCulled=!1,r.renderOrder=-1,{mesh:r,geometry:t,material:n,setNight(e){n.uniforms.uZenith.value.set(e?fo:co),n.uniforms.uHorizon.value.set(e?po:lo)}}}function go(e){return new J(new K(uo),e*.6,e*2.6)}var _o=1.6,vo=.055;function yo({radius:e=25e3,avstand:t=null}={}){return To({radius:e,avstand:t??e*.82,grader:_o,farge:`#fdf6df`,jordskinn:vo,ring:!0})}var bo=46,xo=1.8,So=2.6,Co=5,wo=55;function To({radius:e=25e3,avstand:t=null,grader:n=_o,farge:r=`#ffffff`,jordskinn:i=vo,ring:a=!1}={}){let o=t??e*.82,s=new qe(1,1),c=new je({transparent:!0,depthWrite:!1,side:2,uniforms:{uLysAndel:{value:.75},uLysside:{value:0},uFarge:{value:new K(r)},uJordskinn:{value:i},uSkive:{value:1},uRing:{value:+!!a},uRingR:{value:0},uRingStrek:{value:.02},uTid:{value:0},uPeriode:{value:So}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `}),l=new G(s,c);l.frustumCulled=!1;let u=900,d=n;function f(){let e=2*o*Math.tan(wo*Math.PI/180/2)/u,t=Math.max(2*o*Math.tan(d*Math.PI/180/2),Co*e),n=a?bo*e*1.18:0,r=Math.max(t,n);l.scale.setScalar(r),c.uniforms.uSkive.value=t/r,c.uniforms.uRingR.value=a?bo*e/r:0,c.uniforms.uRingStrek.value=xo*e*2/r}f();let p=new F;return p.add(l),{group:p,mesh:l,geometries:[s],materials:[c],sett(e){if(!e||!Number.isFinite(e.azimut)||!Number.isFinite(e.hoyde))return;let[t,n,r]=Kt(e.azimut,e.hoyde,o);l.position.set(t,n,r),c.uniforms.uLysAndel.value=Math.max(0,Math.min(1,e.lysAndel??.75)),c.uniforms.uLysside.value=Number.isFinite(e.lyssideVinkel)?e.lyssideVinkel:0,l.visible=e.hoyde>-2*Math.PI/180},update(e,t=null){e&&l.quaternion.copy(e.quaternion),Number.isFinite(t)&&(c.uniforms.uTid.value=t)},settSkjermHoyde(e){!Number.isFinite(e)||e<1||(u=e,f())},settGrader(e){!Number.isFinite(e)||e<=0||(d=e,f())},get skiveAndel(){return c.uniforms.uSkive.value},get ringAndel(){return c.uniforms.uRingR.value},dispose(){s.dispose(),c.dispose()}}}function Eo(e){return Math.max(1.7,Math.min(6.2,5.5-.66*e))}function Do(e){return Math.max(.45,Math.min(1,1.1-.1*e))}var Oo=-1*Math.PI/180,ko=.26,Ao=1.7,jo=.85,Mo=2.6,No=Math.max(1,...Bt.map(e=>e.linjer.length)),Po=1,Fo=1.6,Io=.45,Lo=.02;function Ro({radius:e=25e3,lat:t=null,lon:n=null,dato:r=null,starCount:i=160,pikselForhold:a=1,tvingHimmel:o=!1}={}){let s=new F;s.visible=!1;let c=e*.9,l=Number.isFinite(t)&&Number.isFinite(n),u=[],d=[],f=[],p=new Map;if(l){let e=r??new Date,i=Pt(e,n);for(let n=0;n<It.length;n++){let r=It[n],a=Ft(r.ra,r.dek,e),{azimut:o,hoyde:s}=Ut(a.ra,a.dek,i,t);if(s<Oo)continue;let[l,m,h]=Kt(o,s,c);p.set(n,u.length/3),u.push(l,m,h),d.push(Eo(r.mag)),f.push(Do(r.mag))}}else{let e=zo(1337);for(let t=0;t<i;t++){let t=e()*Math.PI*2,n=.12+e()*.88,r=Math.sqrt(Math.max(0,1-n*n));u.push(Math.cos(t)*r*c,n*c,Math.sin(t)*r*c),d.push(1.6+e()*1.6),f.push(.55+e()*.4)}}let m=new $e;m.setAttribute(`position`,new He(new Float32Array(u),3)),m.setAttribute(`storrelse`,new He(new Float32Array(d),1)),m.setAttribute(`styrke`,new He(new Float32Array(f),1));let h=new je({transparent:!0,depthWrite:!1,blending:2,uniforms:{uFarge:{value:new K(`#ffeec4`)},uPikselForhold:{value:Math.max(1,a)}},vertexShader:`
...
`;function Go(e,t,n){let r=new Float32Array(156),i=new Float32Array(104),a=new Float32Array(52),o=new Uint16Array(78),s=1;for(let c=0;c<13;c++){let l=c===0?0:e(),u=1-.55*l,d=e()*Math.PI*2,f=Math.sqrt(e())*u,p=Math.cos(d)*f*t*.42,m=Math.sin(d)*f*t*.42*.72,h=(l*.4+e()*.05)*t*.5,g=t*(n-.38*n*l)*(.88+e()*.26);h>s&&(s=h);let _=[[-1,-1],[1,-1],[1,1],[-1,1]];for(let e=0;e<4;e++){let t=c*4+e;r[t*3]=p,r[t*3+1]=h,r[t*3+2]=m,i[t*2]=_[e][0],i[t*2+1]=_[e][1],a[t]=g}let v=c*4;o.set([v,v+1,v+2,v,v+2,v+3],c*6)}let c=new $e;return c.setAttribute(`aSenter`,new He(r,3)),c.setAttribute(`aHjorne`,new He(i,2)),c.setAttribute(`aRadius`,new He(a,1)),c.setIndex(new He(o,1)),c.boundingSphere=new ct(new Z(0,s*.5,0),t),{geo:c,maksY:s}}function Ko({widthM:e,heightM:t,baseY:n=1200,count:r=14,solRetning:i=new Z(-.5,.707,-.5).normalize(),radiusFaktor:a=.34,kantMyk:o=.18,tetthet:s=.62,lysKontrast:c=.42}={}){let l=new F,u=Ho(42),d=e*1.9,f=t*1.9,p=new K(`#ffffff`),m=new K(`#c6d6e6`),h=[],g=[],_=[];for(let e=0;e<r;e++){let e=1500+u()*2600,{geo:t,maksY:r}=Go(u,e,a),i=new je({vertexShader:Uo,fragmentShader:Wo,transparent:!0,depthWrite:!1,uniforms:{uSolView:{value:new Z(0,1,0)},uLys:{value:p.clone()},uSkygge:{value:m.clone()},uTetthet:{value:s},uKantMyk:{value:o},uKontrast:{value:c},uGlimt:{value:0},uGlimtFarge:{value:new K(`#ffffff`)},uKlyngeHoyde:{value:r*2}}}),v=new G(t,i);v.frustumCulled=!1,v.position.set((u()-.5)*d,n+u()*800,(u()-.5)*f),v.userData.driftM=8+u()*14,v.userData.skyggeRadius=e*.55,l.add(v),h.push(i),g.push(t),_.push(v)}let v=1,y=0,b=1,x=new Z,S=[[0,.55],[.05,.15],[.09,1],[.2,.75],[.34,.22],[.48,0]],C=S[S.length-1][0],w=-1,T=0;function E(e){if(e<=0||e>=C)return 0;for(let t=1;t<S.length;t++){let[n,r]=S[t];if(e<=n){let[i,a]=S[t-1],o=(e-i)/Math.max(n-i,1e-6);return a+(r-a)*o}}return 0}return{group:l,materials:h,geometries:g,skyer:_,glimt(e){let t=_.map((e,t)=>e.visible?t:-1).filter(e=>e>=0);if(!t.length)return null;if(e!=null&&_[e]?.visible)w=e;else{let e=[...t].sort((e,t)=>_[t].scale.x-_[e].scale.x),n=e.slice(0,Math.max(1,Math.ceil(e.length/2)));w=n[Math.floor(Math.random()*n.length)]}return T=0,_[w].position},solRetning:i,setVaer(e){w>=0&&(h[w].uniforms.uGlimt.value=0,w=-1);let t=e?Math.max(1,Math.min(_.length,Math.round(e.antall??_.length))):_.length;for(let e=0;e<_.length;e++)_[e].visible=e<t;let n=e?.gratone??1;for(let t of h)t.uniforms.uTetthet.value=(e?.opasitet??.85)*(s/.85),t.uniforms.uLys.value.setRGB(p.r*n,p.g*n,p.b*n),t.uniforms.uSkygge.value.setRGB(m.r*n,m.g*n,m.b*n);let r=Math.hypot(e?.driftX??1,e?.driftZ??0)||1;v=(e?.driftX??1)/r,y=(e?.driftZ??0)/r,b=e?.driftFart??1},update(e,t){for(let t of _)t.position.x+=v*t.userData.driftM*b*e,t.position.z+=y*t.userData.driftM*b*e,t.position.x>d/2?t.position.x-=d:t.position.x<-d/2&&(t.position.x+=d),t.position.z>f/2?t.position.z-=f:t.position.z<-f/2&&(t.position.z+=f);if(w>=0){T+=e;let t=E(T);h[w].uniforms.uGlimt.value=t,t<=0&&(h[w].uniforms.uGlimt.value=0,w=-1)}if(t){x.copy(i).transformDirection(t.matrixWorldInverse);for(let e of h)e.uniforms.uSolView.value.copy(x)}},dispose(){for(let e of g)e.dispose();for(let e of h)e.dispose()}}}function qo({styrke:e=.3}={}){let t=new Float32Array(42),n={uSkySenter:{value:t},uSkyAntall:{value:0},uSkyHoyde:{value:1500},uSolRetning:{value:new Z(-.5,.707,-.5).normalize()},uSkyggeStyrke:{value:e}};return{uniforms:n,oppdater(e,r,i){let a=0,o=0;for(let n of e){if(a>=14)break;n.visible&&(t[a*3]=n.position.x,t[a*3+1]=n.position.z,t[a*3+2]=n.userData.skyggeRadius??r,o+=n.position.y,a++)}n.uSkyAntall.value=a,a&&(n.uSkyHoyde.value=o/a),i&&n.uSolRetning.value.copy(i)},festTil(e){e.onBeforeCompile=e=>{Object.assign(e.uniforms,n),e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
      ...
      `});p=new G(a,o),p.rotation.x=-Math.PI/2,p.frustumCulled=!1}let m=new F;m.rotation.z=f,m.add(c),p&&m.add(p),a.add(m);let h=null;n&&new ce().load(n,e=>{e.colorSpace=Ke,h=e,s.map=e,s.color.set(`#ffffff`),s.needsUpdate=!0;try{r?.(!0)}catch{}},void 0,()=>{try{r?.(!1)}catch{}});let g=new Z,_=0;return{group:a,mesh:c,legeme:e,navn:i.navn,geometries:p?[o,p.geometry]:[o],materials:p?[s,p.material]:[s],get harTekstur(){return!!h},get harRinger(){return!!p},settRenderLag(e){!Number.isInteger(e)||e<0||e>31||a.traverse(t=>t.layers.set(e))},settFase(e,t){let n=Number.isFinite(e)?e:0,r=Number.isFinite(t)?t:0,i=Math.sin(n);u.position.set(-i*Math.sin(r),i*Math.cos(r),Math.cos(n))},vendMot(e){a.lookAt(e),a.rotateZ(_)},settRull(e){_=Number.isFinite(e)?e:0},settSkala(e){a.scale.setScalar(Math.max(.001,e))},get skala(){return a.scale.x},settRotasjon(e,t){c.rotation.y=e,c.rotation.x=Math.max(-80*Yo,Math.min(80*Yo,t))},get rotasjon(){return{lengde:c.rotation.y,bredde:c.rotation.x}},synligeTrekk(){let e=[];a.updateMatrixWorld(!0),m.updateMatrixWorld(!0);for(let n of i.trekk??[]){let[r,i,o]=Xo(n.lat,n.lon);g.set(r,i,o).applyQuaternion(c.quaternion).applyQuaternion(m.quaternion),!(g.z<=.18)&&(g.multiplyScalar(t*1.02).applyMatrix4(a.matrixWorld),e.push({...n,verden:[g.x,g.y,g.z]}))}return e},setVisible(e){a.visible=!!e},dispose(){o.dispose(),s.dispose(),p?.geometry.dispose(),p?.material.dispose(),h?.dispose(),l?.dispose()}}}var $o=class extends Error{constructor(e,t){super(t??e),this.code=e}};async function es(e,{dem:n,meta:r,getTextureSpec:i,onProgress:a=null,onTextureNote:o=null,options:s={}},l={}){if(!n)throw new $o(`no-dem`,`Kartet mangler høydedata`);let{exaggeration:u=1.15,tvingHimmel:d=!1}=s,f=e=>{try{a?.(e)}catch{}},p=e=>{try{o?.(e)}catch{}},m=Math.min(window.devicePixelRatio||1,(navigator.deviceMemory??4)<=4?1.5:2),h;try{h=new ha({antialias:m<1.8,powerPreference:`high-performance`,alpha:!1,stencil:!1})}catch{throw new $o(`no-webgl`,`WebGL utilgjengelig`)}h.setPixelRatio(m),h.outputColorSpace=Ke,h.toneMapping=0,e.appendChild(h.domElement),h.domElement.style.cssText=`width:100%;height:100%;display:block;touch-action:none;`;let g=new q;g.background=new K(uo),g.fog=go(Math.max(r.widthM,r.heightM));let _=new De(55,1,1,6e4),v=za({widthM:r.widthM,heightM:r.heightM,exaggeration:u});f(`Tegner kartet på terrenget …`);let y=Xa(h),b=Math.min(Za,y),x,S=null;try{S=await no(i(),{sizePx:y}),x=ro(S,n,{renderer:h,sizePx:b}),S.missing&&p(`${S.missing} av ${S.tileCount} kartfliser kunne ikke tegnes på terrenget`)}catch(e){S?.dispose(),S=null,x=so(n),b=y,console.warn(`[3D] Kartbildet kunne ikke rasteriseres:`,e),p(`Kartbildet kunne ikke tegnes på terrenget — viser terrengformene alene`)}let C=null,w=!1,T=!1;f(`Bygger terrengmodellen …`);let E=Ha(n,v,x);g.add(E.mesh);{let{data:e,noData:t}=n,r=0;for(let n=0;n<e.length;n++)(e[n]===t||!Number.isFinite(e[n]))&&r++;let i=e.length?r/e.length:0;i>.33&&p(`${Math.round(i*100)} % av utsnittet mangler høydedata — terrenget der vises på havnivå`)}let D=ho();g.add(D.mesh);let O=Ko({widthM:r.widthM,heightM:r.heightM,baseY:Math.max(1200,E.maxElev*u+350)});O.group.visible=!1,g.add(O.group);let k=Bo({widthM:r.widthM,heightM:r.heightM,toppY:Math.max(2200,E.maxElev*u+1400),maks:700});g.add(k.group);let ee=Vo({toppY:Math.max(1800,E.maxElev*u+900)});g.add(ee.group);let A=qo(),te=.3;A.uniforms.uSolRetning.value.copy(O.solRetning),A.festTil(E.material);let ne=4e3,j=(e,t)=>{let n=e===`mane`?I.mane:I.planetSkive?.(e);n&&(n.mesh.visible=!t,I.settGlobeLegeme?.(t?e:null))},re=new Map,M=null,ie=null,ae=0,N=0,P=null,F=null;try{let e=t(r.widthM/2,r.heightM/2,r);Number.isFinite(e?.lat)&&Number.isFinite(e?.lon)&&(P=e.lat,F=e.lon)}catch{}let I=Ro({lat:P,lon:F,dato:new Date,pikselForhold:h.getPixelRatio(),tvingHimmel:d});g.add(I.group);let L=null,R=!1,oe=Number.isFinite(r.equidistance)&&r.equidistance>0?r.equidistance:20,z=()=>w&&C?C:x;async function B(){if(T)return;let e=z();if(!Qa(e)){e.needsUpdate=!0,E.material.needsUpdate=!0;return}console.warn(`[3D] Terrengteksturen var tømt — bygger den på nytt`);let t=i?.({dark:w});if(t)try{let r=await io(t,n,{renderer:h,sizePx:b,night:w});if(T){r.dispose();return}ve.track(r);let i=e;w&&C?C=r:x=r,E.material.map=z(),E.material.needsUpdate=!0,i.dispose()}catch{let e=so(n);ve.track(e),w&&C?C=e:x=e,E.material.map=z(),E.material.needsUpdate=!0}}let se=1,V=0,H=!1;function ce(){let e=H&&!w;O.group.visible=e,A.uniforms.uSkyggeStyrke.value=e?te:0}let le=g.fog.near,ue=g.fog.far,de=!1,fe=typeof matchMedia==`function`&&matchMedia(`(prefers-reduced-motion: reduce)`).matches,pe=3,me=0,he=new K(uo),ge=new K(`#e8f1ff`);function _e(e){if(!de||fe)return;if(me>0){me-=e,me<=0&&(g.fog.color.copy(he),g.background.copy(he),ee.slukk());return}if(pe-=e,pe>0)return;pe=3+Math.random()*6,me=.3,g.fog.color.copy(ge),g.background.copy(ge);let t=O.glimt();ee.blink(t?t.x:(Math.random()-.5)*r.widthM*1.1,t?t.z:(Math.random()-.5)*r.heightM*1.1,t?t.y-120:void 0,Math.random()*Math.PI*2)}function U(){de=!1,me=0,ee.slukk(),g.fog.color.set(w?mo:uo),g.background.set(w?mo:uo)}let ve=Jo({renderer:h,camera:_,container:e,onResize(e,t){L?.setResolution(e,t),I.setResolution(e,t),l.onResize?.(e,t)},onFrame:(e,t)=>l.onFrame?.(e,t),onContextLost:()=>l.onContextLost?.(),onDead:()=>l.onDead?.(),onContextRestored:()=>{B()},onVisible:()=>{B()}});async function ye(){if(!(T||b>=y))try{f(`Skjerper kartbildet …`);let e=ro(S??await no(i({dark:!1}),{sizePx:y}),n,{renderer:h,sizePx:y});if(T){e.dispose();return}ve.track(e);let t=x;x=e,b=y,w||(E.material.map=x,E.material.needsUpdate=!0),t.dispose()}catch{}finally{S?.dispose(),S=null,f(null)}}if(b<y){let e=()=>{ye()};typeof requestIdleCallback==`function`?requestIdleCallback(e,{timeout:2500}):setTimeout(e,600)}for(let e of[x,E.geometry,E.material,D.geometry,D.material,O,k,ee,I])ve.track(e);f(null);let be=new Z;function xe(t,n,r){be.set(t,n,r).project(_);let i=e.clientWidth,a=e.clientHeight;return{x:(be.x+1)/2*i,y:(1-be.y)/2*a,behind:be.z>1}}return{renderer:h,scene:g,camera:_,coords:v,terrain:E,loop:ve,track:e=>ve.track(e),start:()=>ve.start(),resize:()=>ve.resize(),render(){_.layers.set(0),h.render(g,_),M?.group.visible&&(h.autoClear=!1,h.clearDepth(),_.layers.set(1),h.render(g,_),h.autoClear=!0,_.layers.set(0))},updateAmbient(e,t=null){if(D.mesh.position.copy(_.position),I.group.position.copy(_.position),M?.group.visible&&ie&&(M.group.position.set(_.position.x+ie[0],_.position.y+ie[1],_.position.z+ie[2]),M.vendMot(_.position),ae!==N)){let t=1-Math.exp(-e/.18);ae+=(N-ae)*t,Math.abs(N-ae)<.004&&(ae=N),M.settSkala(ae),ae===0&&(M.setVisible(!1),j(M.legeme,!1))}I.update(_,t),O.group.visible&&(O.update(e,_),A.oppdater(O.skyer,900,O.solRetning)),k.update(e,se,V),_e(e)},project:xe,async setContoursVisible(t){if(R=!!t,R&&!L){let{buildContourLines:t}=await c(async()=>{let{buildContourLines:e}=await import(`./contourLines-C0P5CDkE.js`);return{buildContourLines:e}},__vite__mapDeps([0,1,2,3,4]));L=t(E.dem,v,{intervalM:oe}),L.setResolution(e.clientWidth,e.clientHeight),ve.track(L),g.add(L.group)}L&&(L.group.visible=R)},get contoursVisible(){return R},async setNightMode(e){if(w=!!e,w&&!C)try{C=await io(i({dark:!0}),n,{renderer:h,sizePx:y,night:!0}),ve.track(C)}catch{}let t=z();E.material.map!==t&&(E.material.map=t,E.material.needsUpdate=!0),D.setNight(w),I.setNight(w),!w&&M&&(N=0,ae=0,M.settSkala(.001),M.setVisible(!1),j(M.legeme,!1)),ce(),he.set(w?mo:uo),me=0,g.fog.color.copy(he),g.background.copy(he)},setVaer(e){H=!!e,O.setVaer(e);let t=e?.siktFaktor??1;g.fog.near=le*t,g.fog.far=ue*t,te=.3*(1-(e?.dekning??.55)*.6)*(t<.3?.15:1),ce(),k.setNedbor(e?.nedbor??null,e?.nedborTetthet??0),se=e?.driftX??1,V=e?.driftZ??0,he.set(w?mo:uo),e?.torden?de=!0:U()},get nightOn(){return w},settValgtFormasjon(e){I.settValgt(e)},settTvingHimmel(e){I.settTvingHimmel(e)},get tvingHimmel(){return I.tvingHimmel},aapneGlobe(e){return!e||!Number.isFinite(e.azimut)||!Nt(e.legeme)?!1:(M&&M.legeme!==e.legeme&&(M.setVisible(!1),M.settSkala(.001)),M=re.get(e.legeme)??null,M||(M=Qo({legeme:e.legeme,radius:ne*Math.tan(17*Math.PI/180),teksturUrl:`/lende/data/${Gt[e.legeme].tekstur}`}),M.settRenderLag(1),g.add(M.group),ve.track(M),re.set(e.legeme,M)),ie=Kt(e.azimut,e.hoyde,ne),M.settFase(e.faseVinkel??0,e.lyssideVinkel??0),M.settRull(-(e.parallaktisk??0)),M.settRotasjon(0,0),ae=.05,N=1,M.settSkala(ae),M.setVisible(!0),j(e.legeme,!0),!0)},lukkGlobe(){N=0},get globeAapen(){return!!M?.group.visible&&N>0},dreiGlobe(t,n){if(!M?.group.visible)return;let r=e.clientHeight||1,i=2*Math.PI/r,a=M.rotasjon;M.settRotasjon(a.lengde+t*i,a.bredde+n*i)},globeTrekkPaaSkjerm(){if(!M?.group.visible||ae<.6)return[];let e=[];for(let t of M.synligeTrekk()){let n=xe(t.verden[0],t.verden[1],t.verden[2]);n.behind||e.push({navn:t.navn,norsk:t.norsk,merk:t.merk,type:t.type,x:n.x,y:n.y})}return e},get globeHarTekstur(){return!!M?.harTekstur},get globeLegeme(){return M?.group.visible&&N>0?M.legeme:null},get globeNavn(){return M?.navn??null},get synligePlaneter(){return I.synligePlaneter},revalidateTexture:B,dispose(){T=!0,S?.dispose(),S=null,ve.dispose()}}}var ts=new Set([`505`,`506`,`507`]),ns=14038815,rs=9067038,is=25;function as(e,t,n,{liftM:r=4}={}){let a=new F,o=[],s=[],c=(e,a)=>{let o=i(t,e,a);return Number.isFinite(o)?n.toWorld(e,a,o+r):null},l=(e,t,n,r,i)=>{let a=Math.hypot(r-t,i-n),o=Math.max(1,Math.ceil(a/is)),s=c(t,n);for(let a=1;a<=o;a++){let l=a/o,u=c(t+(r-t)*l,n+(i-n)*l);s&&u&&e.push(s[0],s[1],s[2],u[0],u[1],u[2]),s=u}},u=t=>{let n=[];for(let r of e??[]){if(ts.has(r.isomCode)!==t)continue;let e=r.coordinates;for(let t=0;t+1<e.length;t++)l(n,e[t][0],e[t][1],e[t+1][0],e[t+1][1])}if(!n.length)return;let r=new va;r.setPositions(n);let i=new ya({color:t?ns:rs,linewidth:t?2.6:3.4,transparent:!0,opacity:t?.95:.8,depthTest:!0});o.push(r),s.push(i);let c=new Ra(r,i);c.frustumCulled=!1,a.add(c)};return u(!1),u(!0),{group:a,geometries:o,materials:s,get isEmpty(){return o.length===0},setVisible(e){a.visible=!!e},setResolution(e,t){for(let n of s)n.resolution.set(e,t)},dispose(){for(let e of o)e.dispose();for(let e of s)e.dispose()}}}var os=2.2,ss=5,cs=1200,ls=.12,us=60.4,ds=1e6;function fs(e,t,n,r,a=0){let o=i(e,n,r);return t.toWorld(n,r,(Number.isFinite(o)?o:0)+a)}function ps(e){return Math.min(ss,Math.max(1,e/cs))}function ms(e,t,n,r){if(![t,n,r].every(Number.isFinite))return 0;let i=ps(Math.hypot(e.x-t,e.y-n,e.z-r)),a=e.y-n,o=(e.x-t)**2+(e.z-r)**2,s=ls*ls,c=81-s*us*us,l=2*s*us*a,u=(-l+Math.sqrt(l*l+4*c*s*(a*a+o)))/(2*c),d=Math.min(i,u);return Number.isFinite(d)?d:0}function hs(e,t,n,{stemColor:r=16777215}={}){let i=e.length,a=new st(os,os,55,8),o=new ht(9,12,10),s=new it({color:r}),c=new it({vertexColors:!1}),l=new oe(a,s,Math.max(1,i)),u=new oe(o,c,Math.max(1,i));l.frustumCulled=!1,u.frustumCulled=!1,l.instanceMatrix.setUsage(x),u.instanceMatrix.setUsage(x);let d=new Float32Array(i*3),f=new Le,p=new K,m=new Set;for(let r=0;r<i;r++){let i=e[r],[a,o,s]=fs(t,n,i.x,i.y);[a,o,s].every(e=>Number.isFinite(e)&&Math.abs(e)<=ds)?(d[r*3]=a,d[r*3+1]=o,d[r*3+2]=s):m.add(r)}let h=new Z,g=new Z(NaN,NaN,NaN),_=!0,v=new Int32Array(i).fill(-1),y=0,b=!0,S=t=>{let n=0;for(let e=0;e<i;e++){if(m.has(e))continue;let r=d[e*3],i=d[e*3+1],a=d[e*3+2],o=t(e,r,i,a);o>0&&(f.position.set(r,i+55/2*o,a),f.scale.setScalar(o),f.rotation.set(0,0,0),f.updateMatrix(),l.setMatrixAt(n,f.matrix),f.position.set(r,i+us*o,a),f.updateMatrix(),u.setMatrixAt(n,f.matrix),v[n]!==e&&(v[n]=e,b=!0),n++)}if(y=n,l.count=n,u.count=n,l.instanceMatrix.needsUpdate=!0,u.instanceMatrix.needsUpdate=!0,l.boundingSphere=null,u.boundingSphere=null,l.boundingBox=null,u.boundingBox=null,b){for(let t=0;t<n;t++)p.set(e[v[t]].color),u.setColorAt(t,p);u.instanceColor&&(u.instanceColor.needsUpdate=!0),b=!1}};S(e=>+!m.has(e));let C=null;return{stems:l,heads:u,geometries:[a,o],materials:[s,c],get count(){return i},get invalidIndices(){return m},isUgyldig(e){return m.has(e)},basePosition(e){return[d[e*3],d[e*3+1],d[e*3+2]]},setVisibleSet(e){C=e,_=!0},isVisible(e){return!C||C.has(e)},update(e){h.copy(e.position),!(!_&&h.distanceToSquared(g)<.0625)&&(_=!1,g.copy(h),S((e,t,n,r)=>C&&!C.has(e)?0:ms(h,t,n,r)))},raycast(e){let t=e.intersectObjects([u,l],!1);for(let e of t){if(e.instanceId==null||e.instanceId>=y)continue;let t=v[e.instanceId];if(t>=0)return t}return null},dispose(){a.dispose(),o.dispose(),s.dispose(),c.dispose(),l.dispose(),u.dispose()}}}var gs=220,_s=120,vs=5,ys=.15,bs=11,xs=14;function Ss({scene:e,dem:t,coords:n,project:r,maxVisible:i=_s}){let a=new F;e.add(a);let o=[],s=null,c=null,u=!0,d=new Set,f=0,p=new Z,m=!1,h=()=>{s&&=(a.remove(s.stems),a.remove(s.heads),s.dispose(),null)},g=()=>o.map((e,t)=>({f:e,i:t})).filter(({f:e,i:t})=>!s?.isUgyldig(t)&&(!c||c.has(_t(e.kind)))),_=()=>{if(!s)return;let e=[];for(let{f:t,i:n}of g()){let[i,a,o]=s.basePosition(n),c=m?Math.hypot(p.x-i,p.y-a,p.z-o):0,l=r(i,a+60.4*(m?ms(p,i,a,o):1),o);if(l.behind)continue;let u=r(i,a,o),d=Math.max(xs,Math.abs(u.y-l.y)/2),f=bt(t.kind,t.categories);e.push({id:String(n),score:(f?.priority??3)*10+1/(1+c/1e3),sx:(u.x+l.x)/2,sy:(u.y+l.y)/2,halfW:Math.max(bs,d*2*ys),halfH:d,group:(f?.priority??0)>=5?`priority`:`quota`})}let t=Zt(e,{cellPx:150,K:3,pad:vs,prevShown:d,maxVisible:i});d=t,s.setVisibleSet(new Set([...t].map(Number)))};return{group:a,get visible(){return u},get count(){return o.length},get visibleIndices(){return new Set([...d].map(Number))},setFeatures(e){if(h(),o=e??[],o.length&&(s=hs(o.map(e=>({x:e.x,y:e.y,color:l(e)})),t,n),a.add(s.stems),a.add(s.heads),s.invalidIndices.size)){let e=[...s.invalidIndices].slice(0,5).map(e=>`${o[e]?.kind??`?`}:${o[e]?.name??`?`}`);console.warn(`[3D] ${s.invalidIndices.size} nål(er) hadde ubrukelig posisjon og er utelatt: ${e.join(`, `)}`)}d=new Set,a.visible=u,_()},setVisible(e){u=!!e,a.visible=u},setGroups(e){c=e,d=new Set,_()},update(e){p.copy(e.position),m=!0,s&&u&&s.update(e)},maybeDeclutter(e){!s||!u||e-f<=gs||(f=e,_())},raycast(e){if(!s||!u)return null;let t=s.raycast(e);if(t==null||!o[t])return null;let n=o[t];return{feature:n,world:s.basePosition(t),radiusM:n.areaM2?Math.sqrt(n.areaM2/Math.PI):60}},dispose(){h(),e.remove(a)}}}function Cs(e,t,{now:n=()=>performance.now(),slopPx:r=12,maxMs:i=600}={}){let a=null,o=e=>{a={x:e.clientX,y:e.clientY,t:n()}},s=e=>{let o=a;a=null,o&&(Math.hypot(e.clientX-o.x,e.clientY-o.y)>r||n()-o.t>i||t(e))};return e.addEventListener(`pointerdown`,o),e.addEventListener(`pointerup`,s),{dispose(){e.removeEventListener(`pointerdown`,o),e.removeEventListener(`pointerup`,s)}}}var ws=120*Math.PI/180,Ts=8*Math.PI/180,Es=25e3,Ds=2,Os=60,ks=70*Math.PI/180,As=20,js=(e,t)=>Math.atan2(t[1]-e[1],t[0]-e[0]);function Ms(e,t){let n=Math.abs(e-t)%(Math.PI*2);return n>Math.PI&&(n=Math.PI*2-n),n}function Ns(e,t){let n=(t-e)%(Math.PI*2);return n>Math.PI&&(n-=Math.PI*2),n<=-Math.PI&&(n+=Math.PI*2),n}function Ps(e,t,n){let r=e.graph,i=r.getEdgeAttributes(t,n),a=r.getNodeAttribute(t,`pos`),o=r.getNodeAttribute(n,`pos`);return{node:n,pos:o,bearing:js(a,o),length:i?.length??Math.hypot(o[0]-a[0],o[1]-a[1]),isomCode:i?.isomCode??null}}function Fs(e,t,n){let r=[];return e.graph.forEachNeighbor(t,i=>{i!==n&&r.push(Ps(e,t,i))}),r}function Is(e,t,n,r){let i=e.graph,a=t,o=n,s=i.getEdgeAttribute(t,n,`length`),c=new Set([t,n]);for(;s<r;){let e=i.degree(o);if(e===1)return{deadEnd:!0,lengthM:s};if(e>=3)return{deadEnd:!1,lengthM:s};let t=null;if(i.forEachNeighbor(o,e=>{e!==a&&(t=e)}),!t||c.has(t))return{deadEnd:!1,lengthM:s};c.add(t),s+=i.getEdgeAttribute(o,t,`length`),a=o,o=t}return{deadEnd:!1,lengthM:s}}function Ls(e,t,n,r=100){return Is(e,t,n,r).deadEnd}function Rs(e,t,n=100){let r=e?.graph;if(!r?.hasNode?.(t))return!1;let i=r.degree(t);if(i===0)return!0;if(i>=3)return!1;let a=[];return i===1&&a.push({deadEnd:!0,lengthM:0}),r.forEachNeighbor(t,r=>a.push(Is(e,t,r,n))),a.some(e=>!e.deadEnd&&e.lengthM>=n)||!a.some(e=>e.deadEnd)?!1:a.reduce((e,t)=>e+t.lengthM,0)<n}function zs(e,t){let n=null;for(let r of e){let e=Ms(r.bearing,t),i=o[r.isomCode]??1.5;if(!n){n={...r,turn:e,cost:i};continue}let a=e-n.turn;if(a<-Ts){n={...r,turn:e,cost:i};continue}a>Ts||(i<n.cost||i===n.cost&&r.length>n.length)&&(n={...r,turn:e,cost:i})}return n}function Bs(e,t,{visits:n=new Map,maxGapM:r=Os,coneRad:i=ks}={}){let a=e?.graph;if(!a?.hasNode?.(t.node))return null;let o=e.nodesWithin?.(t.pos,r);if(!o?.length)return null;let s=new Set;a.forEachNeighbor(t.node,e=>s.add(e));for(let r of o){if(r.id===t.node||s.has(r.id)||n.has(r.id)||!(r.distM>.5))continue;let a=js(t.pos,r.pos);if(Ms(a,t.bearing)>i)continue;let o=zs(Fs(e,r.id,null),a);if(!(!o||o.turn>ws)&&!Ls(e,r.id,o.node)&&!e.gapObstacle?.(t.pos,r.pos,r.distM))return{node:r.id,pos:r.pos,bearing:a,length:r.distM,isomCode:null}}return null}function Vs(e,t,{headingXY:n=null,firstNodeId:r=null,maxLengthM:i=Es,hopGapM:a=Os}={}){let o={coordinates:[],lengthM:0,nodeIds:[],junctions:[],hops:[]};if(!e?.graph?.hasNode?.(t))return o;let s=e.graph.getNodeAttribute(t,`pos`),c=[[s[0],s[1]]],l=[t],u=[],d=new Map([[t,1]]),f=Fs(e,t,null);if(f.length>1){let n=f.filter(n=>!Ls(e,t,n.node));n.length&&(f=n)}if(!f.length)return{...o,coordinates:c,nodeIds:l};let p;if(r&&(p=f.find(e=>e.node===r)??null),!p){if(n&&Math.hypot(n[0],n[1])>1e-9){let e=Math.atan2(n[1],n[0]);p=zs(f,e)}else p=f.reduce((e,t)=>t.length>e.length?t:e)}if(!p)return{...o,coordinates:c,nodeIds:l};let m=0,h=t,g=p,_=[];for(;g;){c.push([g.pos[0],g.pos[1]]),l.push(g.node),m+=g.length;let t=(d.get(g.node)??0)+1;if(d.set(g.node,t),t>Ds||m>=i)break;let n=Fs(e,g.node,h);n.length>1&&(n=n.filter(t=>!Ls(e,g.node,t.node)));let r=n.length?zs(n,g.bearing):null;if(r&&r.turn>ws&&(r=null),!r){if(a<=0||_.length>=As)break;let t=Bs(e,g,{visits:d,maxGapM:a});if(!t)break;_.push({alongM:m,gapM:t.length}),h=null,g=t;continue}n.length>1&&u.push({alongM:m,nodeId:g.node,chosenNodeId:r.node,options:n.map(e=>({nodeId:e.node,bearing:e.bearing,turn:Ms(e.bearing,g.bearing),turnSigned:Ns(g.bearing,e.bearing),isomCode:e.isomCode,lengthM:e.length})).sort((e,t)=>e.turn-t.turn)}),h=g.node,g=r}return{coordinates:c,lengthM:m,nodeIds:l,junctions:u,hops:_}}function Hs(e,t,n,{tolM:r=120,stubM:i=100}={}){let a=e?.nearestNode?.(t);if(!a||a.distM>r||Rs(e,a.id,i))return null;let o=e.graph.getNodeAttribute(a.id,`pos`),s=o[0]-n[0],c=o[1]-n[1],l=Math.hypot(s,c);return l<1e-6?{nodeId:a.id,headingXY:[1,0],distM:a.distM}:{nodeId:a.id,headingXY:[s/l,c/l],distM:a.distM}}function Us(e,t,n,r,i={}){let a=t.nodeIds.indexOf(n.nodeId);if(a<0)return t;let o=Vs(e,n.nodeId,{...i,firstNodeId:r});if(o.coordinates.length<2)return t;let s=t.coordinates.slice(0,a+1),c=t.nodeIds.slice(0,a+1),l=0;for(let e=1;e<s.length;e++)l+=Math.hypot(s[e][0]-s[e-1][0],s[e][1]-s[e-1][1]);return{coordinates:[...s,...o.coordinates.slice(1)],nodeIds:[...c,...o.nodeIds.slice(1)],lengthM:l+o.lengthM,junctions:[...t.junctions.filter(e=>e.alongM<n.alongM),...o.junctions.map(e=>({...e,alongM:e.alongM+l}))],hops:[...(t.hops??[]).filter(e=>e.alongM<n.alongM),...(o.hops??[]).map(e=>({...e,alongM:e.alongM+l}))]}}function Ws(e,t,n,{stepM:r=5,offsetM:a=3,maxPoints:o=2500}={}){let s=Ks(e,r,o),c=s.length,l=new Float32Array(c),u=0;for(let e=0;e<c;e++){let n=t?i(t,s[e][0],s[e][1]):NaN;u=Number.isFinite(n)?n:u,l[e]=u}let d=0;for(;d<c&&l[d]===0&&t;){let e=i(t,s[d][0],s[d][1]);if(Number.isFinite(e))break;d++}for(let e=0;e<d&&d<c;e++)l[e]=l[d];let f=qs(l),p=new Float32Array(c*3),m=new Float32Array(c),h=0;for(let e=0;e<c;e++){let[t,r]=s[e],[i,o,c]=n.toWorld(t,r,f[e]+a);p[e*3]=i,p[e*3+1]=o,p[e*3+2]=c,e>0&&(h+=Math.hypot(t-s[e-1][0],r-s[e-1][1])),m[e]=h}return{points3:p,cumM:m,totalM:h}}function Gs(e,t,{offsetM:n=3}={}){let r=[],i=e.cumM.length;for(let a=0;a<i;a++)r.push({distM:e.cumM[a],elev:t.worldYToElev(e.points3[a*3+1])-n});return r}function Ks(e,t,n){if(!e||e.length<2)return(e??[]).map(e=>[e[0],e[1]]);let r=0;for(let t=1;t<e.length;t++)r+=Math.hypot(e[t][0]-e[t-1][0],e[t][1]-e[t-1][1]);let i=Math.max(t,r/Math.max(2,n-1)),a=[[e[0][0],e[0][1]]];for(let t=1;t<e.length;t++){let[n,r]=e[t-1],[o,s]=e[t],c=Math.hypot(o-n,s-r),l=Math.max(1,Math.ceil(c/i));for(let e=1;e<=l;e++)a.push([n+(o-n)*e/l,r+(s-r)*e/l])}return a}function qs(e){let t=e.length;if(t<3)return e;let n=new Float32Array(t);n[0]=e[0],n[t-1]=e[t-1];for(let r=1;r<t-1;r++)n[r]=(e[r-1]+e[r]+e[r+1])/3;return n}function Js({points3:e,cumM:t,totalM:n}){let r=t.length,i=(i,a=[0,0,0])=>{if(r===0)return a;let o=Math.max(0,Math.min(n,i)),s=0,c=r-1;for(;s<c;){let e=s+c>>1;t[e]<o?s=e+1:c=e}let l=Math.max(1,s),u=l-1,d=t[l]-t[u]||1,f=(o-t[u])/d;for(let t=0;t<3;t++)a[t]=e[u*3+t]+(e[l*3+t]-e[u*3+t])*f;return a};return{at:i,tangentAt:(e,t=[0,0,0])=>{let r=Math.max(1,n/500),a=i(Math.max(0,e-r)),o=i(Math.min(n,e+r),t),s=o[0]-a[0],c=o[1]-a[1],l=o[2]-a[2],u=Math.hypot(s,c,l)||1;return t[0]=s/u,t[1]=c/u,t[2]=l/u,t},totalM:n}}var Ys=new K(`#dc2626`),Xs=new K(`#f8b4b4`);function Zs(e,{radiusM:t=5}={}){let n=[];for(let t=0;t<e.points3.length/3;t++)n.push(new Z(e.points3[t*3],e.points3[t*3+1],e.points3[t*3+2]));let r=new at(n,!1,`centripetal`),i=Math.min(2200,Math.max(16,n.length-1)),a=new S(r,i,t,6,!1),o=a.attributes.position.count,s=new Float32Array(o);for(let t=0;t<=i;t++){let n=t/i*e.totalM;for(let e=0;e<7;e++){let r=t*7+e;r<o&&(s[r]=n)}}a.setAttribute(`aAlongM`,new He(s,1));let c={uProgressM:{value:0}},l=new it({color:16777215});l.onBeforeCompile=e=>{e.uniforms.uProgressM=c.uProgressM,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
const vec3 doneColor = vec3(${Ys.r.toFixed(4)}, ${Ys.g.toFixed(4)}, ${Ys.b.toFixed(4)});
const vec3 remainColor = vec3(${Xs.r.toFixed(4)}, ${Xs.g.toFixed(4)}, ${Xs.b.toFixed(4)});`).replace(`#include <color_fragment>`,`#include <color_fragment>
...
diffuseColor.rgb = mix(diffuseColor.rgb, vec3(1.0, 1.0, 1.0), glow * 0.55);`)};let u=new G(a,l);return u.frustumCulled=!1,{mesh:u,geometry:a,material:l,setProgress(e){c.uProgressM.value=e}}}function Qs({radiusM:e=9}={}){let t=new ht(e,16,12),n=new it({color:14427686}),r=new G(t,n),i=new we(e*1.6,e*2.2,32),a=new it({color:14427686,transparent:!0,opacity:.5,side:2}),o=new G(i,a);return o.rotation.x=-Math.PI/2,{sphere:r,ring:o,geometries:[t,i],materials:[n,a],setPosition(e,t,n){r.position.set(e,t,n),o.position.set(e,t-6,n)},pulse(e){let t=1+.15*Math.sin(e*3);o.scale.setScalar(t),a.opacity=.35+.2*Math.sin(e*3)}}}function $s(e){return Number.isFinite(e)?e<3e3?64:e<=12e3?128:256:128}function ec({totalM:e,estWalkMinutes:t=null,cumAscent:n=null,speedKmh:r=4.5,timeScale:i=128}={}){let a=0,o=!1,s=1,c=0,l=!1,u=e=>{if(!n||!n.dM.length)return 0;let{dM:t,aM:r}=n,i=0,a=t.length-1;if(e<=t[0])return r[0];if(e>=t[a])return r[a];for(;i<a;){let n=i+a>>1;t[n]<e?i=n+1:a=n}let o=i-1,s=t[i]-t[o]||1,c=(e-t[o])/s;return r[o]+(r[i]-r[o])*c},d=n?.aM.length?n.aM[n.aM.length-1]:0;return{play(){l||(o=!0)},pause(){o=!1},restart(){a=0,c=0,l=!1,o=!0},seek(t){a=Math.max(0,Math.min(e,t)),l=a>=e,l&&(o=!1)},setSpeed(e){r=Math.max(.5,e)},setTimeScale(e){i=Math.max(.1,e)},setSpeedFactor(e){s=Math.max(0,Math.min(1,e))},tick(t){if(!o||l)return{alongM:a,finished:l};let n=Math.min(t,.1);return a+=r/3.6*i*n*s,c+=n*i*s,a>=e&&(a=e,l=!0,o=!1),{alongM:a,finished:l}},stats(){let n=Math.max(0,e-a),f=u(a),p=Math.max(0,d-f);return{alongM:a,totalM:e,remainingM:n,pctDone:e>0?a/e:0,ascentSoFarM:f,remainingClimbM:p,etaMin:t?t(n,p):null,virtualElapsedMin:c/60,playing:o,finished:l,speedKmh:r,timeScale:i,speedFactor:s}},get playing(){return o},get alongM(){return a},get finished(){return l}}}function tc(e){let t=(e??[]).filter(e=>e.elev!=null&&Number.isFinite(e.elev));if(t.length<2)return null;let n=new Float32Array(t.length),r=new Float32Array(t.length),i=0;n[0]=t[0].distM;for(let e=1;e<t.length;e++){let a=t[e].elev-t[e-1].elev;a>0&&(i+=a),n[e]=t[e].distM,r[e]=i}return{dM:n,aM:r}}var nc=.25,rc=2e3;function ic(e=[],{onEnter:t=null,onExit:n=null}={}){let r=e.slice(),i=0,a=`CRUISE`,o=0,s=0,c=null,l=!0,u=e=>{i=r.findIndex(t=>t.alongM>e),i<0&&(i=r.length)},d=()=>{c&&n&&n(c),c=null,a=`RESUME`,s=rc,i++};return{tick(e,n){if(!l||!r.length)return{speedFactor:1,state:a,active:c};let u=r[i]??null;if(a===`CRUISE`&&u&&e>=u.alongM-u.approachM&&(a=`APPROACH`),a===`APPROACH`){if(!u)return a=`CRUISE`,{speedFactor:1,state:a,active:c};if(e>=u.alongM)a=`HOLD`,o=u.holdMs,c=u,t&&t(u);else{let t=Math.max(0,Math.min(1,(u.alongM-e)/u.approachM));return{speedFactor:nc+.75*(t*t*(3-2*t)),state:a,active:c}}}if(a===`HOLD`){if(o-=n,o<=0)d();else return{speedFactor:0,state:a,active:c}}if(a===`RESUME`){if(s-=n,s<=0)a=`CRUISE`;else return{speedFactor:nc+.75*(1-s/rc),state:a,active:c}}return{speedFactor:1,state:a,active:c}},skip(){a===`HOLD`&&d()},seek(e){a===`HOLD`&&c&&n&&n(c),c=null,a=`CRUISE`,u(e)},setEvents(e,t=0){r=(e??[]).slice(),u((a===`HOLD`||a===`APPROACH`)&&c?c.alongM:t)},setEnabled(e){l=!!e,!l&&a===`HOLD`&&d()},eventNear(e,t=150){let n=null,i=1/0;for(let a of r){let r=Math.abs(a.alongM-e);r<=t&&r<i&&(i=r,n=a)}return n},get state(){return a},get active(){return c},get pending(){return r.length-i}}}var ac=1483594,oc=14427686,sc=16096779;function cc(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`);t.fillStyle=`#1d4ed8`,lc(t,8,8,112,112,26),t.fill(),t.strokeStyle=`#fff`,t.lineWidth=6,lc(t,8,8,112,112,26),t.stroke(),t.fillStyle=`#fff`,t.font=`bold 84px system-ui, sans-serif`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(`P`,64,70);let n=new X(e);return n.colorSpace=Ke,n}function lc(e,t,n,r,i,a){e.beginPath(),e.moveTo(t+a,n),e.arcTo(t+r,n,t+r,n+i,a),e.arcTo(t+r,n+i,t,n+i,a),e.arcTo(t,n+i,t,n,a),e.arcTo(t,n,t+r,n,a),e.closePath()}function uc(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`);t.fillStyle=`#92400e`,lc(t,8,8,112,112,26),t.fill(),t.strokeStyle=`#fff`,t.lineWidth=6,lc(t,8,8,112,112,26),t.stroke(),t.strokeStyle=`#fff`,t.lineWidth=11,t.lineCap=`round`,t.beginPath(),t.moveTo(82,98),t.lineTo(82,58),t.arc(64,58,18,0,Math.PI,!0),t.lineTo(46,76),t.stroke(),t.fillStyle=`#fff`,t.beginPath(),t.moveTo(32,74),t.lineTo(60,74),t.lineTo(46,100),t.closePath(),t.fill();let n=new X(e);return n.colorSpace=Ke,n}function dc({route:e,via:t=[],isLoop:n=!1,parkingSpots:r=[],pauseSpots:i=[]},a,o){let s=new F,c=new F;s.add(c);let l=[],u=[],d=[],f=[],p=new Map,m=(e,t,n,r)=>{let i=new F,c=new st(os,os,55,8),m=new it({color:16777215}),h=new G(c,m);h.position.y=55/2;let g=new ht(9,16,12),_=new it({color:n}),v=new G(g,_);v.position.y=60.4,i.add(h),i.add(v);let[y,b,x]=fs(a,o,e,t);i.position.set(y,b,x),l.push(c,g),u.push(m,_),s.add(i),d.push(i);let S={...r,world:[y,b,x]};for(let e of[h,v])f.push(e),p.set(e,S)},h=e.coordinates,[g,_]=h[0];if(m(g,_,ac,{kind:`start`,name:n?`Start og mål`:`Start`}),!n){let[e,t]=h[h.length-1];m(e,t,oc,{kind:`mål`,name:`Mål`})}for(let e of t)m(e.svgX,e.svgY,sc,{kind:`via`,name:`Vendepunkt`});let v=(e,t,{sizeM:n,liftM:r,parent:i,kind:s,label:c})=>{if(!e.length)return;let l=t(),d=new se({map:l,transparent:!0,depthWrite:!1});u.push(d),d.userData={tex:l};for(let t of e){let e=new pt(d);e.scale.set(n,n,1);let[l,u,m]=fs(a,o,t.x,t.y,r);e.position.set(l,u,m),i.add(e),f.push(e),p.set(e,{kind:s,name:t.name||c,world:fs(a,o,t.x,t.y)})}};return v(r,cc,{sizeM:46,liftM:40,parent:s,kind:`parkering`,label:`Parkering`}),v(i,uc,{sizeM:42,liftM:95,parent:c,kind:`rast`,label:`Rasteplass`}),{group:s,geometries:l,materials:u,hitMeshes:f,pick(e){for(let t of e.intersectObjects(f,!1)){if(t.object.parent&&t.object.parent.visible===!1)continue;let e=p.get(t.object);if(e)return e}return null},setPinsVisible(e){c.visible=!!e},update(e){for(let t of d){let n=ms(e.position,t.position.x,t.position.y,t.position.z);t.visible=n>0,n>0&&t.scale.setScalar(n)}},dispose(){for(let e of l)e.dispose();for(let e of u)e.userData?.tex?.dispose(),e.dispose()}}}function fc({color:e=16498468}={}){let t=new F,n=new we(24,34,40),r=new it({color:e,transparent:!0,opacity:.7,side:2,depthWrite:!1}),i=new G(n,r);i.rotation.x=-Math.PI/2,t.add(i);let a=new qe(14,220),o=new it({color:e,transparent:!0,opacity:.35,blending:2,depthWrite:!1,side:2}),s=new G(a,o);return s.position.y=110,t.add(s),t.visible=!1,{group:t,geometries:[n,a],materials:[r,o],showAt(e,n,r){t.position.set(e,n+2,r),t.visible=!0},hide(){t.visible=!1},update(e,n){if(!t.visible)return;let a=1+.2*Math.sin(e*2.5);i.scale.setScalar(a),r.opacity=.5+.25*Math.sin(e*2.5);let o=n.position.x-t.position.x,c=n.position.z-t.position.z;s.rotation.y=Math.atan2(o,c)}}}var pc=959977,mc=3718648,hc=1.5,gc=15,_c=120,vc=3,yc=2.6;function bc(e,t){let n=new F;n.visible=!1;let r=new F,a=new st(os,os,55,8),o=new it({color:16777215}),s=new G(a,o);s.position.y=55/2;let c=new ht(9,16,12),l=new it({color:pc}),u=new G(c,l);u.position.y=60.4,r.add(s),r.add(u),n.add(r);let d=new we(.9,1,48),f=[];for(let e=0;e<vc;e++){let t=new it({color:mc,transparent:!0,opacity:0,side:2,depthWrite:!1}),r=new G(d,t);r.rotation.x=-Math.PI/2,r.position.y=hc,n.add(r),f.push({mesh:r,mat:t,phase:e/vc})}for(let e of[n,r,s,u,...f.map(e=>e.mesh)])e.frustumCulled=!1;let p=30;return{group:n,hitMeshes:[u,s],get visible(){return n.visible},get position(){return n.position},setPosition(r){let a=r&&Number.isFinite(r.x)&&Number.isFinite(r.y)&&r.x>=0&&r.x<=t.widthM&&r.y>=0&&r.y<=t.heightM;if(n.visible=!!a,!a)return;let o=i(e,r.x,r.y),[s,c,l]=t.toWorld(r.x,r.y,Number.isFinite(o)?o:0);n.position.set(s,c,l),p=Math.min(_c,Math.max(gc,r.accuracyM??30))},update(e,t){if(!n.visible)return;for(let t of f){let n=(e/yc+t.phase)%1,r=Math.max(.001,p*n);t.mesh.scale.set(r,r,1),t.mat.opacity=.5*(1-n)}let i=ms(t.position,n.position.x,n.position.y,n.position.z);r.visible=i>0,i>0&&r.scale.setScalar(i)},dispose(){a.dispose(),c.dispose(),d.dispose(),o.dispose(),l.dispose();for(let e of f)e.mat.dispose()}}}var xc=3e5,Sc=30;function Cc({windowMs:e=xc,minMoveM:t=Sc}={}){let n=[],r=t=>{for(;n.length&&n[0].t<t-e;)n.shift()};return{push(e,t,i){!Number.isFinite(e)||!Number.isFinite(t)||!Number.isFinite(i)||n.length&&i<=n[n.length-1].t||(n.push({x:e,y:t,t:i}),r(i))},heading(e){if(r(e),n.length<2)return null;let i=n[0],a=n[n.length-1],o=a.x-i.x,s=a.y-i.y,c=Math.hypot(o,s);return c<t?null:[o/c,s/c]},reset(){n.length=0}}}var wc=250,Tc=120,Ec=50*Math.PI/180,Dc=1.5,Oc=90,kc=25,Ac=120,jc=30;async function Mc(e,{dem:t,meta:r,getTextureSpec:o,onProgress:c=null,onTextureNote:l=null,pathFeatures:u=[],barrierFeatures:d=[],features:f=[],tour:p=null,options:m={}}){if(!t)throw new $o(`no-dem`,`Kartet mangler høydedata`);if(p&&(!p.route?.coordinates||p.route.coordinates.length<2))throw new $o(`no-route`,`Ingen rute å vise`);let{exaggeration:h=1.15,speedKmh:g=4.5,timeScale:_=null}=m,v={},y=await es(e,{dem:t,meta:r,getTextureSpec:o,onProgress:c,onTextureNote:l,options:{exaggeration:h,tvingHimmel:m.tvingHimmel??!1}},v),{scene:b,camera:x,coords:S,terrain:C,loop:w}=y,T=new Map,E=(e,t)=>{for(let n of T.get(e)??[])try{n(t)}catch{}},D=p?.estWalkMinutes??m.estWalkMinutes??null,O=_??(p?$s(p.route.lengthM):128),k=as(u,t,S),ee=!0;b.add(k.group),w.track(k),k.setResolution(e.clientWidth,e.clientHeight);let A=null,te=()=>(A===null&&(A=u?.length?s(u,{...a,elevationAt:n(t),barriers:d}):!1),A||null),ne=Ss({scene:b,dem:t,coords:S,project:y.project});f?.length&&ne.setFeatures(f);let j=fc();b.add(j.group),w.track({dispose:()=>{for(let e of j.geometries)e.dispose();for(let e of j.materials)e.dispose()}});let re=null,M=Cc(),ie=e=>{e&&!re&&(re=bc(t,S),b.add(re.group),w.track(re)),re?.setPosition(e),e?M.push(e.x,e.y,Date.now()):M.reset()},ae=null;p&&(ae=dc({route:p.route,via:p.via??[],isLoop:!!p.isLoop,parkingSpots:p.parkingSpots??[],pauseSpots:p.pauseSpots??[]},t,S),b.add(ae.group),w.track(ae));let N=null,P=null,F=null,I=null,L=null,R=null,oe=0,B=null,se=!1,V=null,H=`free`,ce=!1,le=e=>{let n=i(t,e.x,e.y);return S.toWorld(e.x,e.y,Number.isFinite(n)?n:0)},ue=ic([],{onEnter:e=>{let[t,n,r]=le(e);j.showAt(t,n,r),H===`follow`&&R?.setFrameTarget({x:t,y:n,z:r,radius:e.areaM2?Math.sqrt(e.areaM2/Math.PI):60}),E(`feature-enter`,{feature:e})},onExit:e=>{j.hide(),R?.clearFrameTarget(),E(`feature-exit`,{feature:e})}}),de=!1;ue.setEnabled(!1);let fe=()=>{if(F&&=(b.remove(F.mesh),F.geometry.dispose(),F.material.dispose(),null),I){b.remove(I.sphere),b.remove(I.ring);for(let e of I.geometries)e.dispose();for(let e of I.materials)e.dispose();I=null}},pe=()=>{fe(),R?.dispose(),R=null,L=null,P=null,N=null,B=null,V=null,oe=0,ue.setEvents([],0)};function me(e,{alongM:n=0,autoplay:r=!1,animateCamera:i=!0}={}){fe(),N=e;let a=Ws(e.coordinates,t,S);P=Js(a),F=Zs(a),b.add(F.mesh),I=Qs(),b.add(I.sphere),b.add(I.ring);let o=e.fixed&&p?.profileSamples?.length?p.profileSamples:Gs(a,S);for(L=ec({totalM:a.totalM,estWalkMinutes:D,cumAscent:tc(o),speedKmh:g,timeScale:O}),n>0&&L.seek(Math.min(n,a.totalM)),R?R.setRouteLookup(P):(R=Wt({camera:x,dem:t,coords:S,routeLookup:P,domElement:y.renderer.domElement}),R.onHold(e=>E(`camera-hold`,{holding:e}))),ue.setEvents(p?.routeFeatures?.length?Ct(p.routeFeatures,e.coordinates):[],L.alongM),ue.setEnabled(de),oe=0,B=null,V=null;oe<(N.junctions?.length??0)&&N.junctions[oe].alongM<=L.alongM;)oe++;he({inherit:!1,animate:i}),r?L.play():_e()}function he({inherit:e=!0,animate:t=!0}={}){!N||!R||(H=`follow`,ce=!1,j.hide(),U.setEnabled(!1),R.enter(L.alongM,{inherit:e,animate:t}),R.setInputEnabled(L.playing),E(`camera`,{detached:!1}))}function ge(){if(!N||H===`free`)return;H=`free`,ce=!1,R?.setInputEnabled(!1),R?.clearFrameTarget();let e=P.at(L.alongM),t=Math.hypot(x.position.x-e[0],x.position.y-e[1],x.position.z-e[2]);U.armFromCamera(t),E(`camera`,{detached:!0})}function _e(){if(!N||H!==`follow`)return;let e=L.playing;U.setEnabled(!e),R?.setInputEnabled(e)}let U=await Vt({camera:x,dem:t,coords:S,domElement:y.renderer.domElement,autoRotate:!p,enabled:!p});U.onTakeOver(()=>{!N||L?.playing||ge()}),U.onTakeOverCancelled(()=>{N&&H===`free`&&(ce=!0)});function ve(e,t){let n=te();if(!n)return!1;let r=U.cameraSvgXY(),i=Hs(n,[e,t],r,{tolM:Oc});if(!i)return!1;let a=Vs(n,i.nodeId,{headingXY:i.headingXY});return a.coordinates.length<2?!1:(me({...a,fixed:!1},{autoplay:!1}),E(`trip-start`,{lengthM:a.lengthM,junctions:a.junctions.length,fixed:!1}),!0)}function ye(){if(!N||N.fixed)return;let e=P?.at(L?.alongM??0),t=e?Math.hypot(x.position.x-e[0],x.position.y-e[1],x.position.z-e[2]):400;pe(),j.hide(),H=`free`,U.armFromCamera(t),E(`trip-end`,{})}let be=new Ze,xe=new z;function Se(e,{radiusM:t=60,headingXY:n=null}={}){N&&(L.pause(),ge(),ce=!1),U.flyTo(e[0],e[1],e[2],{radiusM:t,headingXY:n})}let Ce=new Z;function we(){return x.getWorldDirection(Ce),{azimut:Math.atan2(Ce.x,-Ce.z)*180/Math.PI,hoyde:Math.asin(Math.max(-1,Math.min(1,Ce.y)))*180/Math.PI}}let Te=[],Ee=null,De={x:0,y:0};function Oe(){if(!Te.length)return;let e=y.renderer.domElement.clientWidth,t=y.renderer.domElement.clientHeight,n=(De.x+1)/2*e,r=(1-De.y)/2*t,i=({azimut:e,hoyde:t})=>{let[n,r,i]=Kt(e,t,2e4),a=y.project(x.position.x+n,x.position.y+r,x.position.z+i);return{x:a.x,y:a.y,bak:a.behind}},a=null,o=1/0;for(let e of Te){let t;if(e.type===`formasjon`)t=Rt(n,r,(e.punkter??[]).map(i),e.segmenter);else{let a=i(e);if(a.bak)continue;t=Math.hypot(a.x-n,a.y-r)}if(t>46)continue;let s=e.type===`formasjon`?t:t-18;s<o&&(o=s,a=e)}a&&(W(a),E(`himmel-valgt`,{objekt:a}))}function W(e){Ee=e??null,y.settValgtFormasjon(e?.type===`formasjon`?e:null),e&&U.seMot(e.azimut,e.hoyde),e&&(e.type===`mane`||e.type===`planet`)?K(e):ke()}let G=null;function K(e){let t=e.type===`mane`?`mane`:String(e.id??``).replace(/^planet:/,``);if(!y.aapneGlobe({...e,legeme:t})){ke();return}U.setEnabled(!1),E(`globe`,{apen:!0,legeme:t,navn:y.globeNavn,harTekstur:y.globeHarTekstur})}function ke(){y.globeAapen&&(y.lukkGlobe(),G=null,(!N||H===`free`||!L?.playing)&&U.setEnabled(!0),E(`globe`,{apen:!1}))}let Ae=e=>{y.globeAapen&&(G={x:e.clientX,y:e.clientY})},je=e=>{!G||!y.globeAapen||(y.dreiGlobe(e.clientX-G.x,e.clientY-G.y),G={x:e.clientX,y:e.clientY})},Me=()=>{G=null};function q(e){if(H===`follow`&&R?.holdConsumed)return;if(y.globeAapen){ke(),E(`globe-avsluttet`,{objekt:Ee});return}let t=y.renderer.domElement.getBoundingClientRect();if(xe.x=(e.clientX-t.left)/t.width*2-1,xe.y=-((e.clientY-t.top)/t.height)*2+1,be.setFromCamera(xe,x),De={x:xe.x,y:xe.y},re?.visible&&be.intersectObjects(re.hitMeshes,!1)[0]){let e=re.position;j.hide(),Se([e.x,e.y,e.z],{radiusM:90,headingXY:M.heading(Date.now())}),E(`fly-to-gps`,{});return}let n=ne.raycast(be);if(n){j.showAt(...n.world),Se(n.world,{radiusM:n.radiusM}),E(`feature`,{feature:{...n.feature,type:Dt(n.feature)}});return}let r=ae?.pick(be);if(r){j.showAt(...r.world),Se(r.world,{radiusM:70}),E(`feature`,{feature:{name:r.name,type:r.kind===`parkering`||r.kind===`rast`?r.kind:`veipunkt`,waypoint:r.kind}});return}let i=be.intersectObject(C.mesh,!1)[0];if(!i)return Oe();let{x:a,y:o}=S.toSvg(i.point.x,i.point.z),s=()=>{let e=te();return!!e&&!!Hs(e,[a,o],U.cameraSvgXY(),{tolM:Oc})};if(N){N.fixed&&ee&&s()&&E(`tour-locked`,{});return}if(!ee){s()&&E(`paths-hidden`,{x:a,y:o});return}ve(a,o)||E(`no-path`,{x:a,y:o})}let Ne=Cs(y.renderer.domElement,q);{let e=y.renderer.domElement;e.addEventListener(`pointerdown`,Ae),e.addEventListener(`pointermove`,je),e.addEventListener(`pointerup`,Me),e.addEventListener(`pointercancel`,Me)}let Pe=0,Fe=0,J=0,Ie=!1;Object.assign(v,{onResize(e,t){k.setResolution(e,t)},onFrame(e,t){if(ce&&he({inherit:!0,animate:!1}),N&&L){let n=e*1e3,r=L.finished;L.tick(e);let i=L.alongM;!r&&L.finished&&(ue.seek(i),_e());let a=L.playing?ue.tick(i,n):{speedFactor:1,state:ue.state,active:ue.active};L.setSpeedFactor(a.speedFactor);let o=P.at(i);I.setPosition(o[0],o[1],o[2]),I.pulse(t),F.setProgress(i),H===`follow`?R.update(e,i):U.update(e),Y(i)}else U.update(e);j.update(t,x),re?.update(t,x),ae?.update(x),y.updateAmbient(e,t),ne.update(x),y.render();let n=t*1e3;if(ne.maybeDeclutter(n),y.globeAapen&&n-Fe>Tc&&(Fe=n,E(`globe-trekk`,{trekk:y.globeTrekkPaaSkjerm()})),n-J>Tc&&(J=n,E(`blikk`,we())),n-Pe>wc){if(Pe=n,N&&L){let e=L.stats(),t=P.at(L.alongM);E(`progress`,{...e,walking:!0,fixed:!!N.fixed,detached:H===`free`,serOpp:H===`free`&&U.himmelVipp>0,elevM:S.worldYToElev(t[1])-3}),e.finished&&E(`finished`,e)}else E(`progress`,{walking:!1,autoRotating:U.autoRotating,serOpp:U.himmelVipp>0,elevM:S.worldYToElev(x.position.y)})}},onContextLost:()=>E(`context-lost`,{}),onDead:()=>E(`engine-dead`,{})});function Y(e){if(!N.junctions?.length)return;let t=N.junctions[oe];t&&e>=t.alongM-Ac&&B!==t&&(B=t,E(`junction`,{junction:t})),se&&B&&V!==B&&L.playing&&e>=B.alongM-kc&&(V=B,L.pause(),_e(),E(`junction-pause`,{junction:B})),t&&e>t.alongM+jc&&(oe++,V===t&&(V=null),B===t&&(B=null,E(`junction`,{junction:null})))}return p&&me({...p.route,fixed:!0},{autoplay:!1,animateCamera:!1}),w.start(),E(`ready`,{pathCount:u?.length??0,fixed:!!p}),{setFeatures(e){ne.setFeatures(e??[])},setPinsVisible(e){ne.setVisible(e),ae?.setPinsVisible(e),e||j.hide()},setPinGroups(e){ne.setGroups(e)},setPathsVisible(e){ee=!!e,k.setVisible(ee)},get hasPaths(){return!k.isEmpty},setUserPosition:ie,overview(){j.hide(),W(null),N&&(L.pause(),ge(),ce=!1),U.resetToOverview()},followRoute(){he({inherit:!0})},get detached(){return H===`free`},get autoRotating(){return U.autoRotating},get himmelVipp(){return U.himmelVipp},get blikk(){return we()},settTvingHimmel(e){y.settTvingHimmel(e)},seMotNord(){U.seMot(0,we().hoyde*Math.PI/180)},settBlikkHoyde(e){Number.isFinite(e)&&U.settBlikkHoyde(e*Math.PI/180)},seOppMotHimmelen(e=Ec){U.seMot(U.blikkAzimut,e,{tid:Dc,ease:`ut`})},setHimmelObjekter(e){Te=Array.isArray(e)?e:[],Ee&&!Te.some(e=>e.id===Ee.id)&&W(null)},velgHimmel:W,fokuserHimmel(){return Ee?(U.seMot(Ee.azimut,Ee.hoyde),!0):!1},get valgtHimmel(){return Ee},get globeAapen(){return y.globeAapen},lukkGlobe:ke,globeTrekkPaaSkjerm:()=>y.globeTrekkPaaSkjerm(),get walking(){return!!N},get isFixedTour(){return!!N?.fixed},get tripLengthM(){return N?.lengthM??0},get totalM(){return P?.totalM??0},play(){L&&(he({inherit:!1,animate:!0}),L.play(),_e())},pause(){L?.pause(),_e()},restart(){L&&(L.restart(),ue.seek(0),he({inherit:!1,animate:!0}),_e())},stopTrip(){ye()},scrubStart(){L?.pause(),H===`free`&&he({inherit:!0}),_e()},scrub(e){if(!(!L||!N)){for(L.seek(e),ue.seek(e),oe=0;oe<(N.junctions?.length??0)&&N.junctions[oe].alongM<=L.alongM;)oe++;B&&(B=null,V=null,E(`junction`,{junction:null}))}},scrubEnd(){_e()},setTimeScale(e){O=e,L?.setTimeScale(e)},setAutoPauseJunctions(e){se=!!e},chooseBranch(e){let t=te();if(!t||!N||N.fixed||!B)return;let n=Us(t,N,B,e);if(n===N)return;let r=L.alongM;B=null,E(`junction`,{junction:null}),me({...n,fixed:!1},{alongM:r,autoplay:!0})},setPoiStops(e){de=!!e,ue.setEnabled(de),de&&L&&ue.seek(L.alongM)},skipFeature(){ue.skip()},setContoursVisible:e=>y.setContoursVisible(e),get contoursVisible(){return y.contoursVisible},setNightMode:e=>y.setNightMode(e),setVaer:e=>y.setVaer(e),on:(e,t)=>{T.has(e)||T.set(e,new Set),T.get(e).add(t)},off:(e,t)=>T.get(e)?.delete(t),resize:()=>y.resize(),get state(){return L?{...L.stats(),walking:!0,fixed:!!N?.fixed,detached:H===`free`}:{walking:!1}},dispose(){if(!Ie){Ie=!0,Ne.dispose();{let e=y.renderer.domElement;e.removeEventListener(`pointerdown`,Ae),e.removeEventListener(`pointermove`,je),e.removeEventListener(`pointerup`,Me),e.removeEventListener(`pointercancel`,Me)}pe(),U.dispose(),ne.dispose(),T.clear(),y.dispose()}}}}var Nc=e({PIN_GROUPS:()=>Ot,TourSceneError:()=>$o,buildFeatureTimeline:()=>Ct,clusterFeaturesByMeters:()=>wt,collectAllFeatures:()=>Et,collectBrukerminnePins:()=>xt,collectMapFeatures:()=>kt,countByGroup:()=>gt,create3dScene:()=>Mc,defaultTimeScale:()=>$s,featureType:()=>Dt,findParkingSpots:()=>vt,findPauseSpots:()=>yt,fmtAscent:()=>At,fmtDurationMin:()=>qt,fmtKm:()=>Jt,fmtMoh:()=>Mt,groupOfKind:()=>_t,loadHeritageForMap:()=>St,loadNveFeatures:()=>Tt,poiColor:()=>l});export{Ot as PIN_GROUPS,$o as TourSceneError,Ct as buildFeatureTimeline,wt as clusterFeaturesByMeters,Et as collectAllFeatures,xt as collectBrukerminnePins,kt as collectMapFeatures,gt as countByGroup,Mc as create3dScene,$s as defaultTimeScale,Dt as featureType,vt as findParkingSpots,yt as findPauseSpots,At as fmtAscent,qt as fmtDurationMin,Jt as fmtKm,Mt as fmtMoh,_t as groupOfKind,va as i,St as loadHeritageForMap,Tt as loadNveFeatures,Ra as n,l as poiColor,ya as r,Nc as t};