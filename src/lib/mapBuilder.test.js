...
import { buildSvg, bboxFromCenter, viewportAspect, autoMapSquare, PRINT_ASPECT, makeLabelNameClaimer, klassifiserSmaabygg } from './mapBuilder.js'
...
describe('autoMapSquare — kvadratisk utsnitt (v11.0.32)', () => {
  ...
  it('beholder den skjerm-utledede høyden og utvider bredden til kvadrat', () => {
    ...
    expect(sqHeight).toBeCloseTo(4, 6)          // høyden bevart
    expect(sqWidth).toBeCloseTo(sqHeight, 6)    // bredde = høyde (kvadrat)
  })

  it('PRINT_ASPECT er √2 (A-format, brukt av format-valget i pickeren)', () => {
