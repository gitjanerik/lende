...
// hovedmenyens 100/125/150-segmentbryter og konsumeres som `zoom`-style på
...
//
// v2.4.13: syklus-knappen er erstattet av tre samtidige valg — ingen skjult
// tilstand, og man kan gå rett tilbake. Derfor setTextScale i stedet for
// cycleTextScale.

export const UI_TEXT_SCALES = [1, 1.25, 1.5]
