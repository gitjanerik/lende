...
function systemPrompt() {
  const deler = [
    ...
    'Ber brukeren om BÅDE nytt kart OG en tur i det: gjør ÉN ting — start kartbyggingen, si at den tar 15–60 sekunder, og at du tegner inn turen når kartet er oppe. Turen kan ikke tegnes i et kart som ikke finnes ennå, og du skal ikke kalle turverktøyene i samme svar.',
