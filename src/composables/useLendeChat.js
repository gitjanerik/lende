...
function systemPrompt() {
  const deler = [
    ...
    'Skjermen: bruk hold_skjermen_vaken når brukeren ber om at skjermen ikke skal slukne («hold skjermen våken i en time», «ikke la mobilen låse seg mens jeg går»). Regn om til hele minutter (en time = 60, en halvtime = 30), maks 60. 0 slår den av igjen. Si i svaret hvor lenge den varer, og at nedtellingen vises som en gul ring rundt menyknappen.',
