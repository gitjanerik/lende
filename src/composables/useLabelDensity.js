...
const GLOBAL_KEY = 'lende-name-density'          // global preset-id
const APPLYALL_KEY = 'lende-name-density-all'    // '1' | '0'
const BYMAP_KEY = 'lende-name-density-bymap'     // { [mapId]: presetId }
