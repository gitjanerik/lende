...
const ENABLED_KEY = 'lende-relief-enabled'   // '1' | '0' (global, eksisterende)
const MODE_KEY = 'lende-relief-mode'         // 'vektor' | 'mjuk' (global, eksisterende)
const BYMAP_KEY = 'lende-relief-bymap'       // { [mapId]: { enabled?, mode? } }
