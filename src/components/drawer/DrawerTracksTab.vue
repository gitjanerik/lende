...
<template>
  ...
  <div class="space-y-2 mb-3">
    <button @click="onToggleRecording"
      ...
      <span v-if="liveTrackStats" class="text-[11px] text-ink-3 tabular-nums">
    ...
    <div v-if="tracker.isRecording.value"
         class="text-[10px] leading-snug rounded-md px-2 py-1.5 bg-pink-500/10
                border border-pink-300/20 text-ink-2">
  ...
  <div v-if="tracker.tracks.value.length"
       class="text-ink-3 text-[11px] uppercase tracking-wide mb-2">Mine spor</div>
  <div v-if="tracker.tracks.value.length"
    ...
    <div v-for="tr in tracker.tracks.value" :key="tr.id"
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="flex-1 min-w-0">
          <div class="text-[12px] text-ink truncate">
        ...
        <button @click="onExportTrackGpx(tr)"
                ...
                class="w-7 h-7 flex items-center justify-center rounded-md text-ink-3
      ...
      <button v-if="profileFor(tr)"
        ...
        <div class="text-[10px] text-ink-3 tabular-nums leading-tight px-0.5 mt-0.5 text-left">
  ...
  <div v-if="userPos.isWatching" class="mb-2">
    <div class="text-ink-4 text-[10px] uppercase tracking-wide mb-1 px-0.5">
      Din GPS-posisjon
    </div>
    <div class="flex items-stretch gap-2">
      <div class="flex-1 text-ink-3 text-[10.5px] font-mono leading-snug
