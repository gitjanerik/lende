    ...
    <div class="drawer-shell bg-surface border-t border-ink/10 rounded-t-2xl p-4 max-h-[75dvh] overflow-y-auto">
      ...
      <template v-if="profile">
        <svg viewBox="0 0 600 180" preserveAspectRatio="none"
          ...
          <g stroke="currentColor" stroke-opacity="0.07" stroke-width="1">
          ...
          <text x="594" y="14" fill="currentColor" fill-opacity="0.4" font-size="10"
                text-anchor="end">0 m</text>
          <text x="594" y="174" fill="currentColor" fill-opacity="0.4" font-size="10"
                text-anchor="end">
